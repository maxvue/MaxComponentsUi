...
describe('Auditoria Arquitetural: Acessibilidade de InputBase e Consumidores', () => {
    it('as 28 famílias de componentes de entrada devem conectar atributos de controle e ID aos elementos operáveis', () => {
        const consumers = getComponentsUsingInputBase();
        expect(consumers.length).toBe(27);
        ...
        expect(allFamilies.length).toBe(28);
    });
