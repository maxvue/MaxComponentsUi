...
declare function __VLS_template(): {
    ...
    refs: {
        fileUploadRef: ({
            ...
            $emit: ((e: "error", event: import('primevue/fileupload').FileUploadErrorEvent) => void) & ((e: "upload", event: import('primevue/fileupload').FileUploadUploadEvent) => void) & ((e: "progress", event: import('primevue/fileupload').FileUploadProgressEvent) => void) & ((e: "select", event: import('primevue/fileupload').FileUploadSelectEvent) => void) & ((e: "clear") => void) & ((e: "before-upload", event: import('primevue/fileupload').FileUploadBeforeUploadEvent) => void) & ((e: "uploader", event: import('primevue/fileupload').FileUploadUploaderEvent) => void) & ((e: "before-send", event: import('primevue/fileupload').FileUploadBeforeSendEvent) => void) & ((e: "remove", event: import('primevue/fileupload').FileUploadRemoveEvent) => void) & ((e: "removeUploadedFile", event: import('primevue/fileupload').FileUploadRemoveUploadedFile) => void);
