...
const props = withDefaults(defineProps(), { value: '' });
const message = computed(() => {
    if (hasContent(props.message ?? props.msg))
        return props.message ?? props.msg;
...
const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    variant: "on",
    ...{ class: "max-input" },
    ...{ class: ({ float: __VLS_ctx.attrs.float !== undefined, done: __VLS_ctx.done, caution: __VLS_ctx.caution || __VLS_ctx.done === false }) },
}));
...
if (__VLS_ctx.icon ?? __VLS_ctx.iconLeft ?? __VLS_ctx.i) {
    ...
    // @ts-ignore
    [attrs, done, done, caution, icon, icon, iconLeft, iconLeft, i, i,];
    var __VLS_16;
}
var __VLS_24 = {};
...
if (__VLS_ctx.message) {
    ...
    const __VLS_38 = __VLS_asFunctionalComponent1(__VLS_37, new __VLS_37({
        size: "small",
        ...{ class: (`input-message ${__VLS_ctx.done === false ? 'error' : ''}`) },
        variant: "simple",
    }));
    ...
    const { default: __VLS_42 } = __VLS_40.slots;
    {
        ...
        // @ts-ignore
        [done, label, label, message, iconMessage, iconMessage,];
    }
    (__VLS_ctx.message);
    // @ts-ignore
    [message,];
