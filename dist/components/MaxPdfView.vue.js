...
if (__VLS_ctx.is_open) {
    ...
    let __VLS_11;
    /** @ts-ignore @type { | typeof __VLS_components.VuePdfEmbed | typeof __VLS_components.VuePdfEmbed} */
    VuePdfEmbed;
    // @ts-ignore
    const __VLS_12 = __VLS_asFunctionalComponent1(__VLS_11, new __VLS_11({
        ...
        textLayer: (false),
        source: (props.file),
        width: (__VLS_ctx.size.width),
        height: (__VLS_ctx.size.height),
    }));
    ...
    let __VLS_16;
    const __VLS_17 = ({ rendered: {} },
        { onRendered: (__VLS_ctx.rendered) });
    const __VLS_18 = ({ loaded: {} },
        { onLoaded: (__VLS_ctx.loaded) });
    const __VLS_19 = ({ progress: {} },
        { onProgress: (__VLS_ctx.progressPdf) });
    const { default: __VLS_20 } = __VLS_14.slots;
    {
        const { 'before-page': __VLS_21 } = __VLS_14.slots;
        const [slotProps] = __VLS_vSlot(__VLS_21);
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
            ...{ class: "header-page" },
        });
        /** @type {__VLS_StyleScopedClasses['header-page']} */ ;
        (slotProps.page);
        (__VLS_ctx.total);
        // @ts-ignore
        [size, size, rendered, loaded, progressPdf, total,];
    }
    // @ts-ignore
    [];
    var __VLS_14;
