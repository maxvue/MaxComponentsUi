...
export const PLAYGROUND_CATALOG: CatalogComponent[] = [
    ...
    { name: 'MaxInputDiscount', family: 'inputs', scenarioId: 'inputs-special', description: 'Input numérico para descontos em moeda e porcentagem com alternância e cálculo de preço.' },
    ...
    { name: 'MaxInputMoney', family: 'inputs', scenarioId: 'inputs-special', description: 'Input numérico especializado para valores monetários com máscara e formatação.' },
