import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Tr as normalizeClass, Yt as renderSlot } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { Kt as bt, R as f, an as vt } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$4 } from "./baseeditableholder-D0Nbos50.js";
import { t as script$5 } from "./baseicon-CARG44oY.js";
...
var RatingStyle = BaseStyle.extend({
	...
	classes: {
		...
		onIcon: function onIcon(_ref3) {
			return ["p-rating-icon p-rating-on-icon", { "p-invalid": _ref3.instance.$invalid }];
		},
		offIcon: function offIcon(_ref4) {
			return ["p-rating-icon p-rating-off-icon", { "p-invalid": _ref4.instance.$invalid }];
		}
	}
});
//#endregion
//#region ../node_modules/primevue/rating/index.mjs
var script = {
	name: "Rating",
	"extends": {
		name: "BaseRating",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root"), { "data-p": $options.dataP }), [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.stars, function(value) {
		return openBlock(), createElementBlock("div", mergeProps({
			key: value,
			"class": _ctx.cx("option", { value }),
			onClick: function onClick($event) {
				return $options.onOptionClick($event, value);
			}
		}, { ref_for: true }, $options.getPTOptions("option", value), {
			"data-p-active": value <= _ctx.d_value,
			"data-p-focused": value === $data.focusedOptionIndex,
			"data-p": $options.dataOption(value)
		}), [createBaseVNode("span", mergeProps({ "class": "p-hidden-accessible" }, { ref_for: true }, _ctx.ptm("hiddenOptionInputContainer"), { "data-p-hidden-accessible": true }), [createBaseVNode("input", mergeProps({
			type: "radio",
			value,
			name: $options.namex,
		...
		}, { ref_for: true }, _ctx.ptm("hiddenOptionInput")), null, 16, _hoisted_3)], 16), value <= _ctx.d_value ? renderSlot(_ctx.$slots, "onicon", {
			key: 0,
			value,
			...
			return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.onIcon ? "span" : "StarFillIcon"), mergeProps({ "class": [_ctx.cx("onIcon"), _ctx.onIcon] }, { ref_for: true }, _ctx.ptm("onIcon")), null, 16, ["class"]))];
			...
			return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.offIcon ? "span" : "StarIcon"), mergeProps({ "class": [_ctx.cx("offIcon"), _ctx.offIcon] }, { ref_for: true }, _ctx.ptm("offIcon")), null, 16, ["class"]))];
		})], 16, _hoisted_2);
	}), 128))], 16, _hoisted_1);
}
