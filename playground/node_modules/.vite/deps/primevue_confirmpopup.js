...
import { t as script$2 } from "./button-s0-7NKD1.js";
import { t as OverlayEventBus } from "./overlayeventbus-C73SDYte.js";
import { t as script$3 } from "./portal-DbD3yk9J.js";
import { t as ConfirmationEventBus } from "./confirmationeventbus-Mzi7cGev.js";
import { t as FocusTrap } from "./focustrap-B_S_-MEa.js";
//#endregion
//#region node_modules/primevue/confirmpopup/style/index.mjs
...
//#endregion
//#region node_modules/primevue/confirmpopup/index.mjs
var script = {
	name: "ConfirmPopup",
	"extends": {
	...
	methods: {
		...
		alignOverlay: function alignOverlay() {
			...
			var arrowLeft = 0;
			if (containerOffset.left < targetOffset.left) arrowLeft = targetOffset.left - containerOffset.left;
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					if (_this2.visible && _this2.container && !_this2.container.contains(event.target) && !_this2.isTargetClicked(event)) {
						if (_this2.confirmation.onHide) _this2.confirmation.onHide();
						_this2.visible = false;
					} else _this2.alignOverlay();
				};
		...
		bindScrollListener: function bindScrollListener() {
			...
			if (!this.scrollHandler) this.scrollHandler = new ConnectedOverlayScrollHandler(this.target, function() {
				if (_this3.visible) _this3.visible = false;
			});
		...
		bindResizeListener: function bindResizeListener() {
			...
			if (!this.resizeListener) {
				this.resizeListener = function() {
					if (_this4.visible && !Yt()) _this4.visible = false;
				};
		...
		"default": withCtx(function() {
			return [createVNode(Transition, mergeProps({
				...
				"default": withCtx(function() {
					...
					return [$data.visible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
					...
					}) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [!_ctx.$slots.message ? (openBlock(), createElementBlock("div", mergeProps({
						key: 0,
					...
					}), createBaseVNode("span", mergeProps({ "class": _ctx.cx("message") }, _ctx.ptm("message")), toDisplayString($data.confirmation.message), 17)], 16)) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.message), {
						key: 1,
						message: $data.confirmation
					}, null, 8, ["message"])), createBaseVNode("div", mergeProps({ "class": _ctx.cx("footer") }, _ctx.ptm("footer")), [createVNode(_component_Button, mergeProps({
					...
					}), createSlots({ _: 2 }, [$options.acceptIcon || _ctx.$slots.accepticon ? {
						name: "icon",
						fn: withCtx(function(iconProps) {
						...
						"label",
						"pt"
					])], 16)], 64))], 16, _hoisted_1)), [[_directive_focustrap]]) : createCommentVNode("", true)];
				}),
				_: 3
			}, 16, [
				"onEnter",
