import { Er as normalizeProps, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Q as createSlots, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, et as createTextVNode, jr as toDisplayString, q as createCommentVNode, t as Transition, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { Et as Lt, G as J, Gt as b, K as M, Kt as bt, Nt as S, R as f, Vt as Yt, an as vt, at as l, ct as p, gt as D, in as v, it as k, on as z, ut as s, xt as I, z as x } from "./dist-Dc7XnIxt.js";
import { t as ConnectedOverlayScrollHandler } from "./utils-DEvBYYBi.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$2 } from "./baseinput-r8EDSDeX.js";
import { t as script$3 } from "./inputtext-oiJ80p0a.js";
import { t as script$4 } from "./times-CPQgEJqt.js";
...
import { t as script$8 } from "./chevrondown-CJdOe-id.js";
import { t as script$9 } from "./chip-DtSgmRep.js";
import { t as OverlayEventBus } from "./overlayeventbus-DWOw3HsA.js";
import { t as script$10 } from "./portal-A_VwLjGJ.js";
import { t as script$11 } from "./virtualscroller-B8t8phff.js";
import { t as script$12 } from "./check-DeOt25Y5.js";
import { t as script$13 } from "./checkbox-DOy0dhRA.js";
import { r as FilterService } from "./api-DQ9IOApK.js";
import { t as script$14 } from "./search-bdYteUlY.js";
//#endregion
//#region ../node_modules/primevue/multiselect/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/multiselect/index.mjs
var script$1 = {
...
var script = {
	...
	methods: {
		...
		getOptionRenderKey: function getOptionRenderKey(option, index) {
			return this.dataKey ? p(option, this.dataKey) : this.getOptionLabel(option) + "_".concat(index);
		},
		getHeaderCheckboxPTOptions: function getHeaderCheckboxPTOptions(key) {
			return this.ptm(key, { context: { selected: this.allSelected } });
		},
		...
		isOptionDisabled: function isOptionDisabled(option) {
			if (this.maxSelectionLimitReached && !this.isSelected(option)) return true;
		...
		onOptionSelect: function onOptionSelect(event, option) {
			...
			if (selected) value = this.d_value.filter(function(val) {
				return !k(val, _this4.getOptionValue(option), _this4.equalityKey);
			});
		...
		onArrowDownKey: function onArrowDownKey(event) {
			if (!this.overlayVisible) this.show();
				...
				if (event.shiftKey) this.onOptionSelectRange(event, this.startRangeIndex, optionIndex);
		...
		onArrowUpKey: function onArrowUpKey(event) {
			...
			if (event.altKey && !pressedInInputText) {
				...
				if (event.shiftKey) this.onOptionSelectRange(event, optionIndex, this.startRangeIndex);
				this.changeFocusedOptionIndex(event, optionIndex);
				!this.overlayVisible && this.show();
				event.preventDefault();
			}
		...
		onHomeKey: function onHomeKey(event) {
			if (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false) {
				...
				if (event.shiftKey && metaKey) this.onOptionSelectRange(event, optionIndex, this.startRangeIndex);
				this.changeFocusedOptionIndex(event, optionIndex);
				!this.overlayVisible && this.show();
			}
			event.preventDefault();
		...
		onEndKey: function onEndKey(event) {
			if (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false) {
				...
				if (event.shiftKey && metaKey) this.onOptionSelectRange(event, this.startRangeIndex, optionIndex);
				this.changeFocusedOptionIndex(event, optionIndex);
				!this.overlayVisible && this.show();
			}
			event.preventDefault();
		...
		onEnterKey: function onEnterKey(event) {
			if (!this.overlayVisible) {
				this.focusedOptionIndex = -1;
				this.onArrowDownKey(event);
			} else if (this.focusedOptionIndex !== -1) if (event.shiftKey) this.onOptionSelectRange(event, this.focusedOptionIndex);
		...
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					if (_this6.overlayVisible && _this6.isOutsideClicked(event)) _this6.hide();
				};
		...
		getLabelByValue: function getLabelByValue(value) {
			var _this9 = this;
			var matchedOption = (this.optionGroupLabel ? this.flatOptions(this.options) : this.options || []).find(function(option) {
				return !_this9.isOptionGroup(option) && k(_this9.getOptionValue(option), value, _this9.equalityKey);
			});
		...
		getSelectedItemsLabel: function getSelectedItemsLabel() {
			...
			if (pattern.test(selectedItemsLabel)) return selectedItemsLabel.replace(selectedItemsLabel.match(pattern)[0], this.d_value.length + "");
			return selectedItemsLabel;
		},
		onToggleAll: function onToggleAll(event) {
			var _this0 = this;
			if (this.selectAll !== null) this.$emit("selectall-change", {
				originalEvent: event,
		...
		findLastSelectedOptionIndex: function findLastSelectedOptionIndex() {
			var _this17 = this;
			return this.$filled ? M(this.visibleOptions, function(option) {
		...
		findPrevSelectedOptionIndex: function findPrevSelectedOptionIndex(index) {
			var _this19 = this;
			var matchedOptionIndex = this.$filled && index > 0 ? M(this.visibleOptions.slice(0, index), function(option) {
		...
		findNearestSelectedOptionIndex: function findNearestSelectedOptionIndex(index) {
			...
			if (this.$filled) if (firstCheckUp) {
		...
		searchOptions: function searchOptions(event) {
			...
			if (s(this.searchValue)) {
				...
				} else optionIndex = this.visibleOptions.findIndex(function(option) {
					return _this20.isOptionMatched(option);
				});
		...
		changeFocusedOptionIndex: function changeFocusedOptionIndex(event, index) {
			if (this.focusedOptionIndex !== index) {
				...
				this.scrollInView();
				if (this.selectOnFocus) this.onOptionSelect(event, this.visibleOptions[index]);
			}
		},
		scrollInView: function scrollInView() {
			...
			this.$nextTick(function() {
				...
				else if (!_this21.virtualScrollerDisabled) _this21.virtualScroller && _this21.virtualScroller.scrollToIndex(index !== -1 ? index : _this21.focusedOptionIndex);
			});
		},
	...
	computed: {
			...
			if (this.filterValue) {
				...
				if (this.optionGroupLabel) {
					...
					optionGroups.forEach(function(group) {
						var filteredItems = _this23.getOptionGroupChildren(group).filter(function(item) {
		...
		label: function label() {
			var label;
			if (this.d_value && this.d_value.length) if (this.loading && (!this.options || this.options.length === 0)) label = this.placeholder;
			else if (s(this.maxSelectedLabels) && this.d_value.length > this.maxSelectedLabels) return this.getSelectedItemsLabel();
			else {
				label = "";
		...
		allSelected: function allSelected() {
			var _this24 = this;
			return this.selectAll !== null ? this.selectAll : s(this.visibleOptions) && this.visibleOptions.every(function(option) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		createBaseVNode("div", mergeProps({ "class": "p-hidden-accessible" }, _ctx.ptm("hiddenInputContainer"), { "data-p-hidden-accessible": true }), [createBaseVNode("input", mergeProps({
			ref: "focusInput",
			id: _ctx.inputId,
			type: "text",
			readonly: "",
		...
		}, _ctx.ptm("hiddenInput")), null, 16, _hoisted_2)], 16),
		createBaseVNode("div", mergeProps({ "class": _ctx.cx("labelContainer") }, _ctx.ptm("labelContainer")), [createBaseVNode("div", mergeProps({
			"class": _ctx.cx("label"),
			...
			return [_ctx.display === "comma" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString($options.label || "empty"), 1)], 64)) : _ctx.display === "chip" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [_ctx.loading && (!_ctx.options || _ctx.options.length === 0) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(_ctx.placeholder || "empty"), 1)], 64)) : $options.chipSelectedItems ? (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString($options.label), 1)) : (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(_ctx.d_value, function(item, idx) {
				return openBlock(), createElementBlock("span", mergeProps({
					key: "chip-".concat($options.getLabelByValue(item), "_").concat(idx),
					"class": _ctx.cx("chipItem")
				}, { ref_for: true }, _ctx.ptm("chipItem")), [renderSlot(_ctx.$slots, "chip", {
					value: item,
			...
			}), 128)), !_ctx.d_value || _ctx.d_value.length === 0 ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [createTextVNode(toDisplayString(_ctx.placeholder || "empty"), 1)], 64)) : createCommentVNode("", true)], 64)) : createCommentVNode("", true)];
		})], 16, _hoisted_3)], 16),
					...
					"default": withCtx(function() {
						return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
							...
							_ctx.showToggleAll && _ctx.selectionLimit == null || _ctx.filter ? (openBlock(), createElementBlock("div", mergeProps({
								...
								_ctx.showToggleAll && _ctx.selectionLimit == null ? (openBlock(), createBlock(_component_Checkbox, {
									key: 0,
								...
								_ctx.filter ? (openBlock(), createElementBlock("span", mergeProps({
									key: 2,
									role: "status",
									"aria-live": "polite",
									"class": "p-hidden-accessible"
								}, _ctx.ptm("hiddenFilterResult"), { "data-p-hidden-accessible": true }), toDisplayString($options.filterResultMessageText), 17)) : createCommentVNode("", true)
							...
							createBaseVNode("div", mergeProps({
								...
								content: withCtx(function(_ref2) {
									...
									return [createBaseVNode("ul", mergeProps({
										...
										return openBlock(), createElementBlock(Fragment, { key: $options.getOptionRenderKey(option, $options.getOptionIndex(i, getItemOptions)) }, [$options.isOptionGroup(option) ? (openBlock(), createElementBlock("li", mergeProps({
										...
										}, { ref_for: true }, $options.getCheckboxPTOptions(option, getItemOptions, i, "option"), {
											...
											icon: withCtx(function(slotProps) {
												return [_ctx.$slots.optioncheckboxicon || _ctx.$slots.itemcheckboxicon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.optioncheckboxicon || _ctx.$slots.itemcheckboxicon), {
													...
													key: 1,
													"class": [slotProps["class"], _defineProperty({}, _ctx.checkboxIcon, slotProps.checked)]
												}, { ref_for: true }, $options.getCheckboxPTOptions(option, getItemOptions, i, "pcOptionCheckbox.icon")), null, 16, ["class"])) : createCommentVNode("", true)];
											}),
											_: 2
										}, 1032, [
											"defaultValue",
											...
											return [createBaseVNode("span", mergeProps({ ref_for: true }, _ctx.ptm("optionLabel")), toDisplayString($options.getOptionLabel(option)), 17)];
