import { E as withModifiers, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Q as createSlots, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, et as createTextVNode, jr as toDisplayString, q as createCommentVNode, t as Transition, tt as createVNode } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { Bt as Y, Et as Lt, Gt as b, Kt as bt, Nt as S, Vt as Yt, an as vt, at as l, gt as D, in as v, on as z, ut as s, xt as I, z as x } from "./dist-Dc7XnIxt.js";
...
import { t as script$3 } from "./times-CPQgEJqt.js";
import { t as Ripple } from "./ripple-DZ2RYtk8.js";
import { t as script$4 } from "./chevrondown-CJdOe-id.js";
import { t as script$5 } from "./chip-DtSgmRep.js";
import { t as OverlayEventBus } from "./overlayeventbus-DWOw3HsA.js";
import { t as script$6 } from "./portal-A_VwLjGJ.js";
import { t as script$7 } from "./tree-Bt8ead5E.js";
//#endregion
//#region ../node_modules/primevue/treeselect/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/treeselect/index.mjs
var script$1 = {
	name: "BaseTreeSelect",
	"extends": script$2,
	props: {
...
var script = {
	...
	watch: {
		modelValue: {
			handler: function handler() {
				if (!this.selfChange) this.updateTreeState();
	...
	methods: {
		...
		onNodeSelect: function onNodeSelect(node) {
			...
			if (this.selectionMode === "single") this.hide();
		},
		...
		getSelectedItemsLabel: function getSelectedItemsLabel() {
			...
			if (pattern.test(selectedItemsLabel)) return selectedItemsLabel.replace(selectedItemsLabel.match(pattern)[0], Object.keys(this.d_value).length + "");
		...
		onArrowDownKey: function onArrowDownKey(event) {
			...
			this.$nextTick(function() {
				bt(_toConsumableArray(Y(_this.$refs.tree.$el, "[data-pc-section=\"treeitem\"]")).find(function(item) {
		...
		onEnterKey: function onEnterKey(event) {
			if (this.overlayVisible) this.hide();
			else this.onArrowDownKey(event);
			event.preventDefault();
		},
		...
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					if (_this2.overlayVisible && !_this2.selfClick && _this2.isOutsideClicked(event)) _this2.hide();
		...
		fillNodeMap: function fillNodeMap(node, nodeMap) {
			...
			if (node.children && node.children.length > 0) node.children.forEach(function(children) {
		...
		updateTreeState: function updateTreeState() {
			...
			if (keys && this.options && this.options.length > 0) this.updateTreeBranchState(null, null, keys);
		},
	...
	computed: {
		...
		selectedNodes: function selectedNodes() {
			var _this7 = this;
			var selectedNodes = [];
			if (this.d_value && this.options && this.options.length > 0) Object.keys(this.d_value).forEach(function(key) {
				var node = _this7.nodeMap[key];
				if (_this7.isSelected(node, _this7.d_value)) selectedNodes.push(node);
			});
		...
		label: function label() {
			...
			var label;
			if (value.length) if (s(this.maxSelectedLabels) && value.length > this.maxSelectedLabels) label = this.getSelectedItemsLabel();
			else label = value.map(function(node) {
				return node.label;
			}).join(", ");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		createBaseVNode("div", mergeProps({ "class": _ctx.cx("labelContainer") }, _ctx.ptm("labelContainer")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("label") }, _ctx.ptm("label")), [renderSlot(_ctx.$slots, "value", {
			...
			return [_ctx.display === "comma" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString($options.label || "empty"), 1)], 64)) : _ctx.display === "chip" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [$options.chipSelectedItems ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString($options.label), 1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [(openBlock(true), createElementBlock(Fragment, null, renderList($options.selectedNodes, function(node) {
				...
				}, { ref_for: true }, _ctx.ptm("chipItem")), [createVNode(_component_Chip, {
			...
			}), 128)), $options.emptyValue ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(_ctx.placeholder || "empty"), 1)], 64)) : createCommentVNode("", true)], 64))], 64)) : createCommentVNode("", true)];
		})], 16)], 16),
		...
		createBaseVNode("div", mergeProps({
			...
			"aria-haspopup": "tree",
			"aria-expanded": $data.overlayVisible
		}, _ctx.ptm("dropdown")), [renderSlot(_ctx.$slots, _ctx.$slots.dropdownicon ? "dropdownicon" : "triggericon", { "class": normalizeClass(_ctx.cx("dropdownIcon")) }, function() {
			return [(openBlock(), createBlock(resolveDynamicComponent("ChevronDownIcon"), mergeProps({ "class": _ctx.cx("dropdownIcon") }, _ctx.ptm("dropdownIcon")), null, 16, ["class"]))];
		})], 16, _hoisted_3),
			...
			"default": withCtx(function() {
				return [createVNode(Transition, mergeProps({
					...
					"default": withCtx(function() {
						return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
						...
						}, _objectSpread(_objectSpread({}, _ctx.panelProps), _ctx.ptm("panel"))), [
							...
							createBaseVNode("div", mergeProps({
								...
								style: { "max-height": _ctx.scrollHeight }
								...
								"unstyled",
								"pt"
							])) : createCommentVNode("", true), $options.emptyOptions && !_ctx.loading ? (openBlock(), createElementBlock("div", mergeProps({
								key: 1,
