...
function D$1(t, e, o = !0) {
	...
	if (t) {
		...
		} : w$2(t), s = d.height, a = d.width, u = e.offsetHeight, p = e.offsetWidth, f = e.getBoundingClientRect(), g = $$2(), it = k$2(), lt = h$2(), L, N, ot = "top";
		f.top + u + s > lt.height ? (L = f.top + g - s, ot = "bottom", L < 0 && (L = g)) : L = u + f.top + g, f.left + a > lt.width ? N = Math.max(0, f.left + it + p - a) : N = f.left + it, V$1(t) ? t.style.insetInlineEnd = N + "px" : t.style.insetInlineStart = N + "px", t.style.top = L + "px", t.style.transformOrigin = ot, o && (t.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x$2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l = (i = x$2(/-anchor-gutter$/)) == null ? void 0 : i.value) != null ? l : "");
	}
}
function S$1(t, e) {
...
function I(t, e, o = !0, n = void 0) {
	...
	if (t) {
		let i = t.offsetParent ? {
			width: t.offsetWidth,
			height: t.offsetHeight
		} : w$2(t), l = e.offsetHeight, d = e.getBoundingClientRect(), s = h$2(), a, u, p = n != null ? n : "top";
...
function zt(t, e) {
	var o, n;
	if (t) {
		let r = t.parentElement, i = K$1(r), l = h$2(), d = t.offsetParent ? t.offsetWidth : J$1(t), s = t.offsetParent ? t.offsetHeight : G$1(t), a = v$1((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C$2((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), p = "", f = "";
		i.left + a + d > l.width - O$1() ? i.left < d ? e % 2 === 1 ? p = i.left ? "-" + i.left + "px" : "100%" : e % 2 === 0 && (p = l.width - d - O$1() + "px") : p = "-100%" : p = "100%", t.getBoundingClientRect().top + u + s > l.height ? f = `-${s - u}px` : f = "0px", t.style.top = f, t.style.insetInlineStart = p;
	}
}
function Kt(t, e) {
	let o = getComputedStyle(t).getPropertyValue("borderTopWidth"), n = o ? parseFloat(o) : 0, r = getComputedStyle(t).getPropertyValue("paddingTop"), i = r ? parseFloat(r) : 0, l = t.getBoundingClientRect(), s = e.getBoundingClientRect().top + document.body.scrollTop - (l.top + document.body.scrollTop) - n - i, a = t.scrollTop, u = t.clientHeight, p = C$2(e);
...
//#endregion
export { c as $, kt as $t, me as A, Q$1 as At, s$1 as B, Y$2 as Bt, ft as C, J$1 as Ct, k as D, Mt as Dt, je as E, Lt$1 as Et, ve as F, Tt as Ft, J as G, b$2 as Gt, C$1 as H, _ as Ht, w as I, U as It, V as J, dt$1 as Jt, M as K, bt as Kt, s as L, V$1 as Lt, oe as M, Rt as Mt, rr as N, S$1 as Nt, ke as O, Ot, ue as P, T as Pt, a as Q, k$2 as Qt, f as R, W$1 as Rt, dt as S, It as St, ie as T, Kt as Tt, F$1 as U, _t as Ut, B as V, Yt as Vt, H as W, at as Wt, X, h$2 as Xt, W as Y, et as Yt, Y$1 as Z, ht$1 as Zt, ae as _, Dt$1 as _t, De as a, vt as an, l as at, ce as b, Ht as bt, Le as c, p as ct, Nt as d, $$2 as dt, pt as en, ee as et, Q as f, $t as ft, Y as g, D$1 as gt, Ve as h, C$2 as ht, D as i, v$1 as in, k$1 as it, ne as j, R as jt, le as k, P as kt, Lt as l, q as lt, S as m, At$1 as mt, At as n, te as nn, h$1 as nt, Dt as o, z$1 as on, m as ot, Re as p, A as pt, O as q, c$1 as qt, C as r, tt as rn, i as rt, E as s, zt as sn, ne$1 as st, Ae as t, st$1 as tn, g$1 as tt, N as u, s$2 as ut, ar as v, Ft as vt, ht as w, K$1 as wt, de as x, I as xt, b as y, G$1 as yt, x as z, Wt as zt };

//# sourceMappingURL=dist-Dc7XnIxt.js.map