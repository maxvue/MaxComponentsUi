import { Dr as normalizeStyle, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Q as createSlots, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, et as createTextVNode, jr as toDisplayString, q as createCommentVNode, t as Transition, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { K as M, Kt as bt, Nt as S, R as f, Vt as Yt, at as l, ct as p, gt as D, in as v, it as k, on as z, ut as s, xt as I, z as x } from "./dist-Dc7XnIxt.js";
...
import { t as script$7 } from "./chip-DtSgmRep.js";
import { t as OverlayEventBus } from "./overlayeventbus-DWOw3HsA.js";
import { t as script$8 } from "./portal-A_VwLjGJ.js";
import { t as script$9 } from "./virtualscroller-B8t8phff.js";
//#endregion
...
var AutoCompleteStyle = BaseStyle.extend({
	...
	classes: {
		...
		chipItem: function chipItem(_ref3) {
			...
			return ["p-autocomplete-chip-item", { "p-focus": instance.focusedMultipleOptionIndex === i }];
		},
...
//#endregion
//#region ../node_modules/primevue/autocomplete/index.mjs
var script$1 = {
...
var script = {
	...
	watch: { suggestions: function suggestions() {
		if (this.searching) {
			this.show();
	...
	methods: {
		...
		onFocus: function onFocus(event) {
			...
			if (!this.dirty && this.completeOnFocus) this.search(event, event.target.value, "focus");
			this.dirty = true;
			this.focused = true;
		...
		onInput: function onInput(event) {
			...
			if (this.typeahead) {
				...
				if (!this.multiple) this.updateModel(event, query);
				if (query.length === 0) {
					this.searching = false;
					this.hide();
					this.$emit("clear");
		...
		onContainerClick: function onContainerClick(event) {
			this.clicked = true;
			if (this.disabled || this.searching || this.loading || this.isDropdownClicked(event)) return;
			if (!this.overlay || !this.overlay.contains(event.target)) bt(this.multiple ? this.$refs.focusInput : this.$refs.focusInput.$el);
		},
		...
		onOptionSelect: function onOptionSelect(event, option) {
			...
			if (this.multiple) {
				...
				if (!this.isSelected(option)) this.updateModel(event, [].concat(_toConsumableArray(this.d_value || []), [value]));
			} else this.updateModel(event, value);
		...
		onArrowDownKey: function onArrowDownKey(event) {
			...
			if (this.multiple && event.shiftKey) this.onOptionSelectRange(event, this.startRangeIndex, optionIndex);
		...
		onArrowUpKey: function onArrowUpKey(event) {
			...
			if (event.altKey) {
				...
				if (this.multiple && event.shiftKey) this.onOptionSelectRange(event, optionIndex, this.startRangeIndex);
				this.changeFocusedOptionIndex(event, optionIndex);
				event.preventDefault();
			}
		},
		onArrowLeftKey: function onArrowLeftKey(event) {
			...
			this.focusedOptionIndex = -1;
			if (this.multiple) if (l(target.value) && this.$filled) {
		...
		onHomeKey: function onHomeKey(event) {
			...
			if (this.multiple && event.shiftKey && metaKey) this.onOptionSelectRange(event, optionIndex, this.startRangeIndex);
		...
		onEndKey: function onEndKey(event) {
			...
			if (this.multiple && event.shiftKey && metaKey) this.onOptionSelectRange(event, this.startRangeIndex, optionIndex);
		...
		onSpaceKey: function onSpaceKey(event) {
			if (!this.autoOptionFocus && this.focusedOptionIndex !== -1) this.onEnterKey(event);
		},
		...
		onBackspaceKeyOnMultiple: function onBackspaceKeyOnMultiple(event) {
			if (this.focusedMultipleOptionIndex !== -1) this.removeOption(event, this.focusedMultipleOptionIndex);
		},
		...
		alignOverlay: function alignOverlay() {
			...
			if (this.appendTo === "self") I(this.overlay, target);
			else {
		...
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					if (_this6.overlayVisible && _this6.overlay && _this6.isOutsideClicked(event)) _this6.hide();
				};
		...
		scrollInView: function scrollInView() {
			...
			this.$nextTick(function() {
				...
				else if (!_this14.virtualScrollerDisabled) _this14.virtualScroller && _this14.virtualScroller.scrollToIndex(index !== -1 ? index : _this14.focusedOptionIndex);
			});
		},
	...
	computed: {
		...
		inputValue: function inputValue() {
			if (this.$filled) if (_typeof$1(this.d_value) === "object") {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		!_ctx.multiple ? (openBlock(), createBlock(_component_InputText, {
			key: 0,
			ref: "focusInput",
			id: _ctx.inputId,
			type: "text",
		...
		_ctx.multiple ? (openBlock(), createElementBlock("ul", mergeProps({
			...
			return openBlock(), createElementBlock("li", mergeProps({
				...
				"aria-posinset": i + 1
			}, { ref_for: true }, _ctx.ptm("chipItem")), [renderSlot(_ctx.$slots, "chip", mergeProps({
			...
			}, { ref_for: true }, _ctx.ptm("pcChip")), function() {
		...
		}, _ctx.ptm("input")), null, 16, _hoisted_4)], 16)], 16, _hoisted_2)) : createCommentVNode("", true),
		...
		renderSlot(_ctx.$slots, _ctx.$slots.dropdown ? "dropdown" : "dropdownbutton", { toggleCallback: function toggleCallback(event) {
			...
			}, _ctx.ptm("dropdown")), [renderSlot(_ctx.$slots, "dropdownicon", { "class": normalizeClass(_ctx.dropdownIcon) }, function() {
				return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.dropdownIcon ? "span" : "ChevronDownIcon"), mergeProps({ "class": _ctx.dropdownIcon }, _ctx.ptm("dropdownIcon")), null, 16, ["class"]))];
		...
		}, _ctx.ptm("hiddenSearchResult"), { "data-p-hidden-accessible": true }), toDisplayString($options.searchResultMessageText), 17)) : createCommentVNode("", true),
							...
							createBaseVNode("div", mergeProps({
								...
								content: withCtx(function(_ref) {
									...
									return [createBaseVNode("ul", mergeProps({
										...
										}, { ref_for: true }, $options.getPTOptions(option, getItemOptions, i, "option")), [renderSlot(_ctx.$slots, "option", {
											option,
											index: $options.getOptionIndex(i, getItemOptions)
										}, function() {
