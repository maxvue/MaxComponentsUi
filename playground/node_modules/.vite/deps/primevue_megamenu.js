import { Dr as normalizeStyle, Er as normalizeProps, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, jr as toDisplayString, pt as guardReactiveProps, q as createCommentVNode, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { G as J, K as M, Kt as bt, Vt as Yt, at as l, on as z, ot as m, ut as s, z as x } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$3 } from "./basecomponent-BLHYi_5s.js";
import { t as script$4 } from "./angledown-2B_v_4hg.js";
import { t as Ripple } from "./ripple-DZ2RYtk8.js";
import { t as script$5 } from "./angleright-BPHkkynR.js";
import { t as script$6 } from "./bars-B9PrILUJ.js";
//#endregion
//#region ../node_modules/primevue/megamenu/style/index.mjs
var MegaMenuStyle = BaseStyle.extend({
	...
	classes: {
		...
		submenuLabel: function submenuLabel(_ref3) {
			...
			return ["p-megamenu-submenu-label", { "p-disabled": instance.isItemDisabled(processedItem) }];
		},
	...
	inlineStyles: { rootList: function rootList(_ref) {
		return {
			"max-height": _ref.props.scrollHeight,
			overflow: "auto"
		};
	} }
});
//#endregion
//#region ../node_modules/primevue/megamenu/index.mjs
var script$2 = {
	name: "BaseMegaMenu",
	"extends": script$3,
	props: {
	...
	methods: {
		...
		getMenuItemProps: function getMenuItemProps(processedItem, index) {
			return {
				...
				label: mergeProps({ "class": this.cx("label") }, this.getPTOptions(processedItem, index, "label")),
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("ul", mergeProps({
		...
		key: 0,
		"class": [_ctx.cx("submenuLabel", { submenu: $props.submenu }), $options.getItemProp($props.submenu, "class")],
		...
		return openBlock(), createElementBlock(Fragment, { key: $options.getItemKey(processedItem) }, [$options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
			...
			createBaseVNode("span", mergeProps({ "class": _ctx.cx("itemLabel") }, { ref_for: true }, $options.getPTOptions(processedItem, index, "itemLabel")), toDisplayString($options.getItemLabel(processedItem)), 17),
			$options.isItemGroup(processedItem) ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [$props.templates.submenuicon ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.submenuicon), mergeProps({
				key: 0,
				active: $options.isItemActive(processedItem),
				"class": _ctx.cx("submenuIcon")
			}, { ref_for: true }, $options.getPTOptions(processedItem, index, "submenuIcon")), null, 16, ["active", "class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.horizontal || $props.mobileActive ? "AngleDownIcon" : "AngleRightIcon"), mergeProps({
				key: 1,
				"class": _ctx.cx("submenuIcon")
			...
			"label",
			"props"
		]))], 16, _hoisted_3), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock("div", mergeProps({
			key: 0,
			"class": _ctx.cx("overlay")
		}, { ref_for: true }, _ctx.ptm("overlay")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("grid") }, { ref_for: true }, _ctx.ptm("grid")), [(openBlock(true), createElementBlock(Fragment, null, renderList(processedItem.items, function(col) {
			return openBlock(), createElementBlock("div", mergeProps({
				key: $options.getItemKey(col),
				"class": _ctx.cx("column", { processedItem })
			}, { ref_for: true }, _ctx.ptm("column")), [(openBlock(true), createElementBlock(Fragment, null, renderList(col, function(submenu) {
...
var script = {
	...
	watch: { activeItem: function activeItem(newItem) {
		if (s(newItem)) {
	...
	methods: {
		...
		hide: function hide(event, isFocus) {
			...
			if (this.mobileActive) {
				this.mobileActive = false;
				setTimeout(function() {
					bt(_this2.$refs.menubutton, { preventScroll: true });
				}, 1);
			}
		...
		onItemClick: function onItemClick(event) {
			...
			if (this.isSelected(processedItem)) {
				...
				this.dirty = !root;
				if (!this.mobileActive) bt(this.menubar, { preventScroll: true });
			} else if (grouped) this.onItemChange(event);
			else this.hide(originalEvent);
		},
		onItemMouseEnter: function onItemMouseEnter(event) {
			if (!this.mobileActive && this.dirty) this.onItemChange(event);
		},
		...
		onArrowDownKey: function onArrowDownKey(event) {
			if (this.horizontal) if (s(this.activeItem) && this.activeItem.key === this.focusedItemInfo.key) this.focusedItemInfo = {
				index: -1,
				key: "",
		...
		onArrowUpKey: function onArrowUpKey(event) {
			if (event.altKey && this.horizontal) {
				if (this.focusedItemInfo.index !== -1) {
					var processedItem = this.findVisibleItem(this.focusedItemInfo.index);
					if (!this.isProccessedItemGroup(processedItem) && s(this.activeItem)) if (this.focusedItemInfo.index === 0) {
						this.focusedItemInfo = {
						...
						this.activeItem = null;
					} else this.changeFocusedItemInfo(event, this.findFirstItemIndex());
				}
				event.preventDefault();
			} else {
		...
		onArrowRightKey: function onArrowRightKey(event) {
			var processedItem = this.findVisibleItem(this.focusedItemInfo.index);
			if (this.isProccessedItemGroup(processedItem)) {
				if (this.vertical) if (s(this.activeItem) && this.activeItem.key === processedItem.key) this.focusedItemInfo = {
					index: -1,
					key: "",
					parentKey: this.activeItem.key
				};
					...
					if (this.isProccessedItemGroup(_processedItem)) {
						this.onItemChange({
							originalEvent: event,
		...
		onEnterKey: function onEnterKey(event) {
			if (this.focusedItemInfo.index !== -1) {
				...
				!this.isProccessedItemGroup(processedItem) && this.changeFocusedItemInfo(event, this.findFirstFocusedItemIndex());
			}
			event.preventDefault();
		},
		...
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					...
					if (isOutsideContainer && isOutsideTarget) _this3.hide();
				};
		...
		searchItems: function searchItems(event, _char) {
			...
			if (itemIndex !== -1) this.changeFocusedItemInfo(event, itemIndex);
		...
		scrollInView: function scrollInView() {
			...
			var element;
			if (id === null && this.queryMatches) element = this.$refs.menubutton;
			else element = z(this.menubar, "li[id=\"".concat(id, "\"]"));
