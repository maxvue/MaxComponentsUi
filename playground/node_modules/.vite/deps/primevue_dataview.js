...
import "./vue.js";
import { Kt as W, Zt as ee, an as p } from "./dist-DAdOYTgg.js";
import { t as BaseStyle } from "./style-BrUChsnA.js";
import { t as script$2 } from "./basecomponent-BglYeR_S.js";
import { t as script$3 } from "./paginator-BnFL4nuK.js";
//#endregion
//#region node_modules/primevue/dataview/style/index.mjs
var DataViewStyle = BaseStyle.extend({
	...
	classes: {
		...
		pcPaginator: function pcPaginator(_ref2) {
			return "p-dataview-paginator-" + _ref2.position;
		},
...
//#endregion
//#region node_modules/primevue/dataview/index.mjs
var script$1 = {
	name: "BaseDataView",
	"extends": script$2,
	props: {
...
var script = {
		...
		sort: function sort$1() {
			...
			if (this.value) {
				...
				value.sort(function(data1, data2) {
					return ee(p(data1, _this.sortField), p(data2, _this.sortField), _this.sortOrder, comparer);
				});
				return value;
			} else return null;
		},
	...
	computed: {
		...
		items: function items() {
			if (this.value && this.value.length) {
				var data = this.value;
				if (data && data.length && this.sortField) data = this.sort();
				if (this.paginator) {
	...
	components: { DVPaginator: script$3 }
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [
		...
		createBaseVNode("div", mergeProps({ "class": _ctx.cx("content") }, _ctx.ptm("content")), [!$options.empty ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [_ctx.$slots.list && _ctx.layout === "list" ? renderSlot(_ctx.$slots, "list", {
			key: 0,
			items: $options.items
		...
		}, _ctx.ptm("emptyMessage")), [renderSlot(_ctx.$slots, "empty", { layout: _ctx.layout }, function() {
