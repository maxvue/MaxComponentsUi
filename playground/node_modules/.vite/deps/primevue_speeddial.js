import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Q as createSlots, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, q as createCommentVNode, t as Transition, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-mXmJYp7I.js";
import { Bt as Y, Kt as bt, N as rr, on as z } from "./dist-3iz4Wp3G.js";
...
import { t as script$3 } from "./plus-C8sdFFva.js";
import { t as Ripple } from "./ripple-CdUXYuH-.js";
import { t as script$4 } from "./button-s0-7NKD1.js";
//#region node_modules/@primeuix/styles/dist/speeddial/index.mjs
...
//#endregion
//#region node_modules/primevue/speeddial/style/index.mjs
...
//#endregion
//#region node_modules/primevue/speeddial/index.mjs
var script$1 = {
	name: "BaseSpeedDial",
	"extends": script$2,
	props: {
...
var script = {
	...
	methods: {
		...
		onEnterKey: function onEnterKey(event) {
			var _this = this;
			var itemIndex = _toConsumableArray(Y(this.container, "[data-pc-section=\"item\"]")).findIndex(function(item) {
		...
		changeFocusedOptionIndex: function changeFocusedOptionIndex(index) {
			var filteredItems = _toConsumableArray(Y(this.container, "[data-pc-section=\"item\"]")).filter(function(item) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", mergeProps({
		...
		return [createVNode(_component_Button, mergeProps({
			...
			icon: withCtx(function(slotProps) {
				return [renderSlot(_ctx.$slots, "icon", { visible: $data.d_visible }, function() {
					...
					}, _ctx.ptm("pcButton")["icon"], { "data-pc-section": "icon" }), null, 16, ["class"])) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.showIcon ? "span" : "PlusIcon"), mergeProps({
						key: 1,
		...
		return openBlock(), createElementBlock(Fragment, { key: index }, [$options.isItemVisible(item) ? (openBlock(), createElementBlock("li", mergeProps({
		...
		}, { ref_for: true }, _ctx.actionButtonProps, { pt: $options.getPTOptions("".concat(_ctx.$id, "_").concat(index), "pcAction") }), createSlots({ _: 2 }, [item.icon ? {
			name: "icon",
			fn: withCtx(function(slotProps) {
				return [renderSlot(_ctx.$slots, "itemicon", {
					...
					return [createBaseVNode("span", mergeProps({ "class": [item.icon, slotProps["class"]] }, { ref_for: true }, $options.getPTOptions("".concat(_ctx.$id, "_").concat(index), "actionIcon")), null, 16)];
				})];
			}),
			key: "0"
		} : void 0]), 1040, [
