import { Ht as openBlock, K as createBlock, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Yt as renderSlot, Zt as resolveDirective, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { At as Q, Kt as bt, R as f, on as z } from "./dist-Dc7XnIxt.js";
...
import { t as script$2 } from "./chevronup-DA__r3fZ.js";
import { t as script$3 } from "./chevrondown-CJdOe-id.js";
//#region ../node_modules/primevue/accordionheader/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/accordionheader/index.mjs
var script = {
	name: "AccordionHeader",
	"extends": {
	...
	methods: {
		...
		findNextPanel: function findNextPanel(panelElement) {
			var element = (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false) ? panelElement : panelElement.nextElementSibling;
		...
		findPrevPanel: function findPrevPanel(panelElement) {
			var element = (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false) ? panelElement : panelElement.previousElementSibling;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return !_ctx.asChild ? withDirectives((openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
		...
		"default": withCtx(function() {
			return [renderSlot(_ctx.$slots, "default", { active: $options.$pcAccordionPanel.active }), renderSlot(_ctx.$slots, "toggleicon", {
...
//# sourceMappingURL=accordionheader-DRFDvvXE.js.map