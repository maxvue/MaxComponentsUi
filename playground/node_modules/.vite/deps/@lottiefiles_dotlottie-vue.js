import { It as onMounted, Mt as onBeforeUnmount, W as computed, _n as watch, er as toRefs, mt as h$1, qn as ref, rt as defineComponent } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import "./vue.js";
...
var s = typeof window < `u` && window.document !== void 0, c = new Uint8Array([
	80,
	75,
	3,
	4
	...
	`w`,
	`h`
], u = `0.72.0`, d = `@lottiefiles/dotlottie-web`;
var f;
...
function B(e) {
	return l.every((t) => Object.hasOwn(e, t));
}
function V(e) {
...
var q = K(F, `https://cdn.jsdelivr.net/npm/${d}@${u}/dist/dotlottie-player.wasm`, `https://unpkg.com/${d}@${u}/dist/dotlottie-player.wasm`), J = (e) => {
	switch (e) {
...
var ae = class {
	...
	_drainSmEvents() {
		...
		for (; (t = this._dotLottieCore.sm_poll_internal_event()) != null;) {
			...
			if (e.type === `Message`) {
				let t = e.message ?? ``;
				s && t.startsWith(`OpenUrl: `) ? G(t) : this._eventManager.dispatch({
	...
	play() {
		...
		this._drainPlayerEvents(), (e || this._dotLottieCore.is_playing()) && (this._isFrozen = !1, this._startAnimationLoop()), this._canvas && s && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !U(this._canvas) && this.freeze();
	}
	pause() {
	...
	constructor() {
		r(this, `_workers`, /* @__PURE__ */ new Map()), r(this, `_animationWorkerMap`, /* @__PURE__ */ new Map()), r(this, `_eventHandlers`, /* @__PURE__ */ new Map()), r(this, `_rpcHandlers`, /* @__PURE__ */ new Map()), r(this, `_routeMessage`, (e) => {
			let t = e.data;
			if (t.id) {
...
var $ = class e {
	constructor(t) {
		if (r(this, `_eventManager`, new I()), r(this, `_id`, void 0), r(this, `_worker`, void 0), r(this, `_canvas`, void 0), r(this, `_dotLottieInstanceState`, {
			...
			isReady: !1,
			manifest: null
		}), r(this, `_created`, !1), r(this, `_boundOnClick`, null), r(this, `_boundOnPointerUp`, null), r(this, `_boundOnPointerDown`, null), r(this, `_boundOnPointerMove`, null), r(this, `_boundOnPointerEnter`, null), r(this, `_boundOnPointerLeave`, null), r(this, `_pendingConfig`, null), t.canvas) {
	...
	async destroy() {
		this._created && (this._created = !1, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e._workerManager.unregisterEventHandler(this._id), e._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), s && this._canvas instanceof HTMLCanvasElement && (L.unobserve(this._canvas), R.unobserve(this._canvas)));
	}
	async freeze() {
...
var DotLottieVue = defineComponent({
	...
	setup(props, { attrs, expose }) {
		...
		*/
		...
		return () => h$1("div", { ...attrs }, h$1("canvas", {
