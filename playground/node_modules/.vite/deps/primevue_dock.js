import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Tr as normalizeClass, Xt as resolveComponent, Zt as resolveDirective, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { Bt as Y, on as z, ot as m } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as Tooltip } from "./tooltip-CXG5sl4y.js";
import { t as script$3 } from "./basecomponent-BLHYi_5s.js";
import { t as Ripple } from "./ripple-DZ2RYtk8.js";
//#endregion
//#region ../node_modules/primevue/dock/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/dock/index.mjs
var script$2 = {
	name: "BaseDock",
	"extends": script$3,
	props: {
...
var script$1 = {
	...
	methods: {
		...
		findNextOptionIndex: function findNextOptionIndex(index) {
			var matchedOptionIndex = _toConsumableArray(Y(this.$refs.list, "li[data-pc-section=\"item\"][data-p-disabled=\"false\"]")).findIndex(function(link) {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("listContainer") }, _ctx.ptm("listContainer")), [createBaseVNode("ul", mergeProps({
		ref: "list",
		id: $options.idx,
		"class": _ctx.cx("list"),
		role: "menu",
		...
		}), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("itemContent") }, { ref_for: true }, $options.getPTOptions("itemContent", processedItem, index)), [!$props.templates["item"] ? withDirectives((openBlock(), createElementBlock("a", mergeProps({
			key: 0,
			href: processedItem.url,
			"class": _ctx.cx("itemLink"),
			target: processedItem.target,
			tabindex: "-1"
		}, { ref_for: true }, $options.getPTOptions("itemLink", processedItem, index)), [!$props.templates["icon"] && !$props.templates["itemicon"] ? withDirectives((openBlock(), createElementBlock("span", mergeProps({
			key: 0,
			"class": [_ctx.cx("itemIcon"), processedItem.icon]
		}, { ref_for: true }, $options.getPTOptions("itemIcon", processedItem, index)), null, 16)), [[_directive_ripple]]) : (openBlock(), createBlock(resolveDynamicComponent($props.templates["icon"] || $props.templates["itemicon"]), {
			key: 1,
			item: processedItem,
			"class": normalizeClass(_ctx.cx("itemIcon"))
		}, null, 8, ["item", "class"]))], 16, _hoisted_3)), [[
			_directive_tooltip,
			{
