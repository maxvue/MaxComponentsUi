import { Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Q as createSlots, Qt as resolveDynamicComponent, Sn as withCtx, Xt as resolveComponent } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { B as s$1, L as s } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$1 } from "./basecomponent-BLHYi_5s.js";
import { t as script$2 } from "./dialog-gQUu2sWG.js";
//#region ../node_modules/primevue/dynamicdialogeventbus/index.mjs
var DynamicDialogEventBus = s();
//#endregion
//#region ../node_modules/primevue/dynamicdialog/index.mjs
var script = {
	name: "DynamicDialog",
	"extends": {
		...
		"extends": script$1,
		props: {},
		style: BaseStyle.extend({ name: "dynamicdialog" }),
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(true), createElementBlock(Fragment, null, renderList($data.instanceMap, function(instance, key) {
		return openBlock(), createBlock(_component_DDialog, mergeProps({
			...
			_instance: instance
		}, { ref_for: true }, instance.options.props, {
			...
			"default": withCtx(function() {
				return [(openBlock(), createBlock(resolveDynamicComponent(instance.content), mergeProps({ ref_for: true }, instance.options.emits), null, 16))];
			}),
			_: 2
			...
			fn: withCtx(function() {
				return [(openBlock(true), createElementBlock(Fragment, null, renderList($options.getTemplateItems(instance.options.templates.header), function(header, index) {
					return openBlock(), createBlock(resolveDynamicComponent(header), mergeProps({ key: index + "_header" }, { ref_for: true }, instance.options.emits), null, 16);
				}), 128))];
			}),
			key: "0"
			...
			fn: withCtx(function() {
				return [(openBlock(true), createElementBlock(Fragment, null, renderList($options.getTemplateItems(instance.options.templates.footer), function(footer, index) {
					return openBlock(), createBlock(resolveDynamicComponent(footer), mergeProps({ key: index + "_footer" }, { ref_for: true }, instance.options.emits), null, 16);
				}), 128))];
			}),
			key: "1"
		} : void 0]), 1040, [
