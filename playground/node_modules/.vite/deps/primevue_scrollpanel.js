import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Ot as mergeProps, Yt as renderSlot } from "./runtime-dom.esm-bundler-mXmJYp7I.js";
import { Ft as Tt, Rt as W, kt as P } from "./dist-3iz4Wp3G.js";
import { t as BaseStyle } from "./style-CrPRcMN2.js";
import "./vue.js";
import { t as script$1 } from "./basecomponent-9geUNf9j.js";
//#endregion
//#region node_modules/primevue/scrollpanel/style/index.mjs
...
//#endregion
//#region node_modules/primevue/scrollpanel/index.mjs
var script = {
	name: "ScrollPanel",
	"extends": {
	...
	mounted: function mounted() {
		if (this.$el.offsetParent) this.initialize();
	},
	updated: function updated() {
		if (!this.initialized && this.$el.offsetParent) this.initialize();
	},
	...
	methods: {
		...
		calculateContainerHeight: function calculateContainerHeight() {
			...
			if (containerStyles["max-height"] !== "none" && pureContainerHeight === 0) if (this.$refs.content.offsetHeight + parseInt(xBarStyles["height"], 10) > parseInt(containerStyles["max-height"], 10)) this.$el.style.height = containerStyles["max-height"];
			else this.$el.style.height = this.$refs.content.offsetHeight + parseFloat(containerStyles.paddingTop) + parseFloat(containerStyles.paddingBottom) + parseFloat(containerStyles.borderTopWidth) + parseFloat(containerStyles.borderBottomWidth) + "px";
		},
		moveBar: function moveBar() {
			...
			if (this.$refs.content) {
				...
				this.frame = this.requestAnimationFrame(function() {
					if (_this.$refs.xBar) if (_this.scrollXRatio >= 1) {
					...
					if (_this.$refs.yBar) if (_this.scrollYRatio >= 1) {
		...
		onKeyDown: function onKeyDown(event) {
			if (this.orientation === "vertical") switch (event.code) {
				case "ArrowDown":
			...
			else if (this.orientation === "horizontal") switch (event.code) {
				case "ArrowRight":
		...
		onDocumentMouseMove: function onDocumentMouseMove(e) {
			if (this.isXBarClicked) this.onMouseMoveForXBar(e);
			else if (this.isYBarClicked) this.onMouseMoveForYBar(e);
			else {
		...
		requestAnimationFrame: function requestAnimationFrame(f) {
			return (window.requestAnimationFrame || this.timeoutFrame)(f);
		},
	...
	computed: { contentId: function contentId() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [
		createBaseVNode("div", mergeProps({ "class": _ctx.cx("contentContainer") }, _ctx.ptm("contentContainer")), [createBaseVNode("div", mergeProps({
			ref: "content",
		...
		}, _ctx.ptm("content")), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_1)], 16),
		...
		}, _ctx.ptm("barx"), { "data-pc-group-section": "bar" }), null, 16, _hoisted_2),
		createBaseVNode("div", mergeProps({
			ref: "yBar",
			"class": _ctx.cx("bary"),
			tabindex: "0",
		...
		}, _ctx.ptm("bary"), { "data-pc-group-section": "bar" }), null, 16, _hoisted_3)
	], 16);
}
