import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Ot as mergeProps, Sn as withCtx, Xt as resolveComponent, q as createCommentVNode, t as Transition, tt as createVNode } from "./runtime-dom.esm-bundler-mXmJYp7I.js";
import { Rt as W, Vt as Yt, gt as D, kt as P, xt as I, z as x } from "./dist-3iz4Wp3G.js";
import { t as ConnectedOverlayScrollHandler } from "./utils-DrlCrVRm.js";
import { t as BaseStyle } from "./style-CrPRcMN2.js";
import "./vue.js";
import { t as script$1 } from "./baseeditableholder-BJ7_Kdh7.js";
import { t as OverlayEventBus } from "./overlayeventbus-C73SDYte.js";
import { t as script$2 } from "./portal-DbD3yk9J.js";
//#endregion
//#region node_modules/primevue/colorpicker/style/index.mjs
var ColorPickerStyle = BaseStyle.extend({
	...
	classes: {
		...
		preview: function preview(_ref) {
			return ["p-colorpicker-preview", { "p-disabled": _ref.props.disabled }];
		},
...
//#endregion
//#region node_modules/primevue/colorpicker/index.mjs
var script = {
	name: "ColorPicker",
	"extends": {
	...
	beforeUnmount: function beforeUnmount() {
		...
		if (this.picker && this.autoZIndex) x.clear(this.picker);
		this.clearRefs();
	},
	...
	methods: {
		...
		updateHue: function updateHue() {
			if (this.hueHandle) this.hueHandle.style.top = Math.floor(150 - 150 * this.hsbValue.h / 360) + "px";
		},
		updateInput: function updateInput() {
			if (this.$refs.input) this.$refs.input.style.backgroundColor = "#" + this.HSBtoHEX(this.hsbValue);
		},
		...
		RGBtoHEX: function RGBtoHEX(rgb) {
			...
			for (var key in hex) if (hex[key].length === 1) hex[key] = "0" + hex[key];
			return hex.join("");
		},
		...
		toHSB: function toHSB(value) {
			...
			else hsb = this.HEXtoHSB(this.defaultColor);
			if (hsb.s === 0 || hsb.b === 0) hsb.h = this.localHue;
			else this.localHue = hsb.h;
			return hsb;
		},
		...
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					if (_this.overlayVisible && _this.picker && !_this.picker.contains(event.target) && !_this.isInputClicked(event)) _this.overlayVisible = false;
				};
		...
		bindScrollListener: function bindScrollListener() {
			...
			if (!this.scrollHandler) this.scrollHandler = new ConnectedOverlayScrollHandler(this.$refs.container, function() {
				if (_this2.overlayVisible) _this2.overlayVisible = false;
			});
		...
		bindResizeListener: function bindResizeListener() {
			...
			if (!this.resizeListener) {
				this.resizeListener = function() {
					if (_this3.overlayVisible && !Yt()) _this3.overlayVisible = false;
				};
		...
		"default": withCtx(function() {
			return [createVNode(Transition, mergeProps({
				...
				"default": withCtx(function() {
					...
					}, _objectSpread(_objectSpread({}, _ctx.ptm("panel")), _ctx.ptm("overlay"))), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("content") }, _ctx.ptm("content")), [createBaseVNode("div", mergeProps({
					...
					}, _ctx.ptm("colorSelector")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("colorBackground") }, _ctx.ptm("colorBackground")), [createBaseVNode("div", mergeProps({
