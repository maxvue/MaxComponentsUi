import { Er as normalizeProps, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Xt as resolveComponent, pt as guardReactiveProps, q as createCommentVNode, tt as createVNode } from "./runtime-dom.esm-bundler-mXmJYp7I.js";
import { Ht as _ } from "./dist-3iz4Wp3G.js";
import { t as BaseStyle } from "./style-CrPRcMN2.js";
import "./vue.js";
import { t as script$3 } from "./basecomponent-9geUNf9j.js";
import { t as script$4 } from "./chevronup-BHl7bYaC.js";
import { t as script$5 } from "./chevrondown-CAQyo5Qs.js";
//#endregion
//#region node_modules/primevue/organizationchart/style/index.mjs
var OrganizationChartStyle = BaseStyle.extend({
	...
	classes: {
		...
		nodeToggleButton: function nodeToggleButton(_ref2) {
			return ["p-organizationchart-node-toggle-button", { "p-disabled": !_ref2.instance.selectable }];
		},
		nodeToggleButtonIcon: "p-organizationchart-node-toggle-button-icon",
		connectors: "p-organizationchart-connectors",
		connectorDown: "p-organizationchart-connector-down",
		connectorLeft: function connectorLeft(_ref3) {
			return ["p-organizationchart-connector-left", { "p-organizationchart-connector-top": !(_ref3.index === 0) }];
		},
		connectorRight: function connectorRight(_ref4) {
			var props = _ref4.props;
			return ["p-organizationchart-connector-right", { "p-organizationchart-connector-top": !(_ref4.index === props.node.children.length - 1) }];
		},
		nodeChildren: "p-organizationchart-node-children"
	}
});
//#endregion
//#region node_modules/primevue/organizationchart/index.mjs
var script$2 = {
...
var script$1 = {
	...
	methods: {
		...
		getNodeOptions: function getNodeOptions(lineTop, key) {
			return this.ptm(key, { context: { lineTop } });
		},
		onNodeClick: function onNodeClick(event) {
			if (_(event.target, "data-pc-section", "nodetogglebutton") || _(event.target, "data-pc-section", "nodetogglebuttonicon")) return;
			if (this.selectionMode) this.$emit("node-click", this.node);
		},
	...
	computed: {
		...
		childStyle: function childStyle() {
			return { visibility: !this.leaf && this.expanded ? "inherit" : "hidden" };
		},
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("table", mergeProps({ "class": _ctx.cx("table") }, _ctx.ptm("table")), [createBaseVNode("tbody", normalizeProps(guardReactiveProps(_ctx.ptm("body"))), [
		$props.node ? (openBlock(), createElementBlock("tr", normalizeProps(mergeProps({ key: 0 }, _ctx.ptm("row"))), [createBaseVNode("td", mergeProps({ colspan: $options.colspan }, _ctx.ptm("cell")), [createBaseVNode("div", mergeProps({
			"class": [_ctx.cx("node"), $props.node.styleClass],
			onClick: _cache[2] || (_cache[2] = function() {
				return $options.onNodeClick && $options.onNodeClick.apply($options, arguments);
			})
		}, $options.getPTOptions("node")), [(openBlock(), createBlock(resolveDynamicComponent($props.templates[$props.node.type] || $props.templates["default"]), { node: $props.node }, null, 8, ["node"])), $options.toggleable ? (openBlock(), createElementBlock("a", mergeProps({
			key: 0,
			tabindex: "0",
			...
			key: 1,
			"class": _ctx.cx("nodeToggleButtonIcon")
		}, $options.getPTOptions("nodeToggleButtonIcon")), null, 16, ["class"]))], 16)) : createCommentVNode("", true)], 16)], 16, _hoisted_1)], 16)) : createCommentVNode("", true),
		createBaseVNode("tr", mergeProps({
			style: $options.childStyle,
			"class": _ctx.cx("connectors")
		}, _ctx.ptm("connectors")), [createBaseVNode("td", mergeProps({ colspan: $options.colspan }, _ctx.ptm("lineCell")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("connectorDown") }, _ctx.ptm("connectorDown")), null, 16)], 16, _hoisted_2)], 16),
		createBaseVNode("tr", mergeProps({
			style: $options.childStyle,
			"class": _ctx.cx("connectors")
		...
		}, _ctx.ptm("lineCell")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("connectorDown") }, _ctx.ptm("connectorDown")), null, 16)], 16, _hoisted_3)) : createCommentVNode("", true), $props.node.children && $props.node.children.length > 1 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList($props.node.children, function(child, i) {
			return openBlock(), createElementBlock(Fragment, { key: child.key }, [createBaseVNode("td", mergeProps({ "class": _ctx.cx("connectorLeft", { index: i }) }, { ref_for: true }, $options.getNodeOptions(!(i === 0), "connectorLeft")), "\xA0", 16), createBaseVNode("td", mergeProps({ "class": _ctx.cx("connectorRight", { index: i }) }, { ref_for: true }, $options.getNodeOptions(!(i === $props.node.children.length - 1), "connectorRight")), "\xA0", 16)], 64);
		}), 128)) : createCommentVNode("", true)], 16),
		createBaseVNode("tr", mergeProps({
			style: $options.childStyle,
			...
			return openBlock(), createElementBlock("td", mergeProps({
				key: child.key,
				colspan: "2"
			}, { ref_for: true }, _ctx.ptm("nodeCell")), [createVNode(_component_OrganizationChartNode, {
				node: child,
...
var script = {
	...
	data: function data() {
		return { d_collapsedKeys: this.collapsedKeys || {} };
	},
	watch: { collapsedKeys: function collapsedKeys(newValue) {
		...
		onNodeClick: function onNodeClick(node) {
			...
			if (this.selectionMode) {
				...
				if (_selectionKeys[key]) {
					...
					if (this.selectionMode === "single") _selectionKeys = {};
	...
	components: { OrganizationChartNode: script$1 }
};
