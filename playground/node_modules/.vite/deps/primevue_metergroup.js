import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, N as Fragment, Ot as mergeProps, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, jr as toDisplayString, q as createCommentVNode, tt as createVNode } from "./runtime-dom.esm-bundler-mXmJYp7I.js";
import "./vue.js";
...
//#endregion
//#region node_modules/primevue/metergroup/style/index.mjs
...
//#endregion
//#region node_modules/primevue/metergroup/index.mjs
var script$2 = {
	name: "MeterGroup",
	"extends": script$3,
	props: {
...
var script$1 = {
	...
	computed: { dataP: function dataP() {
		return f(_defineProperty$1({}, this.$pcMeterGroup.labelOrientation, this.$pcMeterGroup.labelOrientation));
	} }
};
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("ol", mergeProps({
		...
		return openBlock(), createElementBlock("li", mergeProps({
			key: index + "_label",
			"class": _ctx.cx("label")
		}, { ref_for: true }, _ctx.ptm("label")), [renderSlot(_ctx.$slots, "icon", {
			value: val,
			...
			}, { ref_for: true }, _ctx.ptm("labelIcon")), null, 16)) : (openBlock(), createElementBlock("span", mergeProps({
				key: 1,
				"class": _ctx.cx("labelMarker"),
				style: { backgroundColor: val.color }
			}, { ref_for: true }, _ctx.ptm("labelMarker")), null, 16))];
		}), createBaseVNode("span", mergeProps({ "class": _ctx.cx("labelText") }, { ref_for: true }, _ctx.ptm("labelText")), toDisplayString(val.label) + " (" + toDisplayString(_ctx.$parentInstance.percentValue(val.value)) + ")", 17)], 16);
	}), 128))], 16, _hoisted_1$1);
}
...
var script = {
	...
	methods: {
		...
		percent: function percent() {
			var percentOfItem = ((arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0) - this.min) / (this.max - this.min) * 100;
	...
	components: { MeterGroupLabel: script$1 }
};
var _hoisted_1 = [
	"aria-valuemin",
	"aria-valuemax",
		...
		createBaseVNode("div", mergeProps({
			...
			return renderSlot(_ctx.$slots, "meter", {
				...
				return [$options.roundedPercent(val.value) ? (openBlock(), createElementBlock("span", mergeProps({
					...
					"data-p": $options.dataP
				}, { ref_for: true }, $options.getPTOptions("meter", val, index)), null, 16, _hoisted_3)) : createCommentVNode("", true)];
			});
		}), 128))], 16, _hoisted_2),
