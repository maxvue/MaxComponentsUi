import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Xt as resolveComponent, Zt as resolveDirective, q as createCommentVNode, t as Transition, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { At as Q, Bt as Y, Kt as bt, Rt as W, Ut as _t, Y as W$1, et as ee, kt as P, on as z, z as x } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$5 } from "./basecomponent-BLHYi_5s.js";
import { t as script$6 } from "./times-CPQgEJqt.js";
import { t as Ripple } from "./ripple-DZ2RYtk8.js";
import { t as script$7 } from "./chevronright-aBzqRXmf.js";
import { t as script$8 } from "./chevronup-DA__r3fZ.js";
import { t as script$9 } from "./chevrondown-CJdOe-id.js";
import { t as script$10 } from "./portal-A_VwLjGJ.js";
import { n as unblockBodyScroll, t as blockBodyScroll } from "./utils-B-GGjm2l.js";
import { t as script$11 } from "./chevronleft-DQZEKSLw.js";
import { t as FocusTrap } from "./focustrap-DqdhI8Bv.js";
//#endregion
//#region ../node_modules/primevue/galleria/style/index.mjs
var GalleriaStyle = BaseStyle.extend({
	...
	classes: {
		...
		prevButton: function prevButton(_ref2) {
			return ["p-galleria-prev-button p-galleria-nav-button", { "p-disabled": _ref2.instance.isNavBackwardDisabled }];
		},
		prevIcon: "p-galleria-prev-icon",
		item: "p-galleria-item",
		nextButton: function nextButton(_ref3) {
			return ["p-galleria-next-button p-galleria-nav-button", { "p-disabled": _ref3.instance.isNavForwardDisabled }];
		},
		...
		indicator: function indicator(_ref4) {
			...
			return ["p-galleria-indicator", { "p-galleria-indicator-active": instance.isIndicatorItemActive(index) }];
		},
		indicatorButton: "p-galleria-indicator-button",
		thumbnails: "p-galleria-thumbnails",
		thumbnailContent: "p-galleria-thumbnails-content",
		thumbnailPrevButton: function thumbnailPrevButton(_ref5) {
			return ["p-galleria-thumbnail-prev-button p-galleria-thumbnail-nav-button", { "p-disabled": _ref5.instance.isNavBackwardDisabled }];
		},
		...
		thumbnailItem: function thumbnailItem(_ref6) {
			...
			return ["p-galleria-thumbnail-item", {
				"p-galleria-thumbnail-item-current": _ref6.activeIndex === index,
		...
		thumbnailNextButton: function thumbnailNextButton(_ref7) {
			return ["p-galleria-thumbnail-next-button p-galleria-thumbnail-nav-button", { "p-disabled": _ref7.instance.isNavForwardDisabled }];
		},
		thumbnailNextIcon: "p-galleria-thumbnail-next-icon"
	}
});
//#endregion
//#region ../node_modules/primevue/galleria/index.mjs
var script$4 = {
	name: "BaseGalleria",
	"extends": script$5,
	props: {
...
var script$3 = {
	...
	mounted: function mounted() {
		if (this.autoPlay) this.$emit("start-slideshow");
	},
	methods: {
		getIndicatorPTOptions: function getIndicatorPTOptions(index) {
			return { context: { highlighted: this.activeIndex === index } };
		},
		next: function next() {
		...
		stopSlideShow: function stopSlideShow() {
			if (this.slideShowActive && this.stopSlideShow) this.$emit("stop-slideshow");
		},
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("itemsContainer") }, _ctx.ptm("itemsContainer")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("items") }, _ctx.ptm("items")), [
		$props.showItemNavigators ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
			key: 0,
			type: "button",
		...
		}, _ctx.ptm("prevButton"), { "data-pc-group-section": "itemnavigator" }), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.previousitemicon || "ChevronLeftIcon"), mergeProps({ "class": _ctx.cx("prevIcon") }, _ctx.ptm("prevIcon")), null, 16, ["class"]))], 16, _hoisted_1$3)), [[_directive_ripple]]) : createCommentVNode("", true),
		...
		}, null, 8, ["item"])) : createCommentVNode("", true)], 16, _hoisted_2$2),
		$props.showItemNavigators ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
			key: 1,
			type: "button",
		...
		}, _ctx.ptm("nextButton"), { "data-pc-group-section": "itemnavigator" }), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.nextitemicon || "ChevronRightIcon"), mergeProps({ "class": _ctx.cx("nextIcon") }, _ctx.ptm("nextIcon")), null, 16, ["class"]))], 16, _hoisted_3$2)), [[_directive_ripple]]) : createCommentVNode("", true),
		$props.templates["caption"] ? (openBlock(), createElementBlock("div", mergeProps({
			key: 2,
			"class": _ctx.cx("caption")
		}, _ctx.ptm("caption")), [$props.templates.caption ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.caption), {
			key: 0,
			item: $options.activeItem
		}, null, 8, ["item"])) : createCommentVNode("", true)], 16)) : createCommentVNode("", true)
	], 16), $props.showIndicators ? (openBlock(), createElementBlock("ul", mergeProps({
		key: 0,
		...
		return openBlock(), createElementBlock("li", mergeProps({
		...
		}, { ref_for: true }, _ctx.ptm("indicator", $options.getIndicatorPTOptions(index)), { "data-p-active": $options.isIndicatorItemActive(index) }), [!$props.templates["indicator"] ? (openBlock(), createElementBlock("button", mergeProps({
			key: 0,
			type: "button",
			tabindex: $props.activeIndex === index ? "0" : "-1",
			"class": _ctx.cx("indicatorButton")
		}, { ref_for: true }, _ctx.ptm("indicatorButton", $options.getIndicatorPTOptions(index))), null, 16, _hoisted_5)) : createCommentVNode("", true), $props.templates.indicator ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.indicator), {
			key: 1,
			index,
			...
			"activeIndex",
			"tabindex"
		])) : createCommentVNode("", true)], 16, _hoisted_4$1);
...
var script$2 = {
	...
	updated: function updated() {
		...
		if (this.d_oldNumVisible !== this.d_numVisible || this.d_oldActiveItemIndex !== this.d_activeIndex) {
			if (this.d_activeIndex <= this.getMedianItemIndex()) totalShiftedItems = 0;
			else if (this.value.length - this.d_numVisible + this.getMedianItemIndex() < this.d_activeIndex) totalShiftedItems = this.d_numVisible - this.value.length;
			else if (this.value.length - this.d_numVisible < this.d_activeIndex && this.d_numVisible % 2 === 0) totalShiftedItems = this.d_activeIndex * -1 + this.getMedianItemIndex() + 1;
			else totalShiftedItems = this.d_activeIndex * -1 + this.getMedianItemIndex();
	...
	methods: {
		step: function step(dir) {
			...
			if (this.circular) {
				if (dir < 0 && this.value.length - 1 === this.d_activeIndex) totalShiftedItems = 0;
				else if (dir > 0 && this.d_activeIndex === 0) totalShiftedItems = this.d_numVisible - this.value.length;
			}
		...
		navBackward: function navBackward(e) {
			...
			if (this.d_numVisible - diff - 1 > this.getMedianItemIndex() && (-1 * this.totalShiftedItems !== 0 || this.circular)) this.step(1);
		...
		navForward: function navForward(e) {
			...
			if (nextItemIndex + this.totalShiftedItems > this.getMedianItemIndex() && (-1 * this.totalShiftedItems < this.getTotalPageNumber() - 1 || this.circular)) this.step(-1);
		...
		calculatePosition: function calculatePosition() {
			if (this.$refs.itemsContainer && this.sortedResponsiveOptions) {
				...
				var matchedResponsiveData = { numVisible: this.numVisible };
				for (var i = 0; i < this.sortedResponsiveOptions.length; i++) {
					var res = this.sortedResponsiveOptions[i];
					if (parseInt(res.breakpoint, 10) >= windowWidth) matchedResponsiveData = res;
				}
				if (this.d_numVisible !== matchedResponsiveData.numVisible) this.d_numVisible = matchedResponsiveData.numVisible;
			}
		},
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
	var _directive_ripple = resolveDirective("ripple");
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("thumbnails") }, _ctx.ptm("thumbnails")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("thumbnailContent") }, _ctx.ptm("thumbnailContent")), [
		...
		}, _objectSpread$2(_objectSpread$2({}, $props.prevButtonProps), _ctx.ptm("thumbnailPrevButton")), { "data-pc-group-section": "thumbnailnavigator" }), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.previousthumbnailicon || ($props.isVertical ? "ChevronUpIcon" : "ChevronLeftIcon")), mergeProps({ "class": _ctx.cx("thumbnailPrevIcon") }, _ctx.ptm("thumbnailPrevIcon")), null, 16, ["class"]))], 16, _hoisted_1$2)), [[_directive_ripple]]) : createCommentVNode("", true),
		createBaseVNode("div", mergeProps({
			...
			}, { ref_for: true }, _ctx.ptm("thumbnailItem"), {
			...
			}, { ref_for: true }, _ctx.ptm("thumbnail")), [$props.templates.thumbnail ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.thumbnail), {
				key: 0,
				item
		...
		}, _objectSpread$2(_objectSpread$2({}, $props.nextButtonProps), _ctx.ptm("thumbnailNextButton")), { "data-pc-group-section": "thumbnailnavigator" }), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.nextthumbnailicon || ($props.isVertical ? "ChevronDownIcon" : "ChevronRightIcon")), mergeProps({ "class": _ctx.cx("thumbnailNextIcon") }, _ctx.ptm("thumbnailNextIcon")), null, 16, ["class"]))], 16, _hoisted_4)), [[_directive_ripple]]) : createCommentVNode("", true)
	], 16)], 16);
}
...
var script$1 = {
	...
	watch: {
		"$attrs.value": function $attrsValue(newVal) {
			if (newVal && newVal.length < this.numVisible) this.numVisible = newVal.length;
		},
	...
	methods: {
		getPTOptions: function getPTOptions(key) {
			return this.ptm(key, { props: _objectSpread$1(_objectSpread$1({}, this.$attrs), {}, {
				pt: this.pt,
		...
		startSlideShow: function startSlideShow() {
			...
			this.interval = setInterval(function() {
				_this.activeIndex = _this.$attrs.circular && _this.$attrs.value.length - 1 === _this.activeIndex ? 0 : _this.activeIndex + 1;
	...
	computed: { closeAriaLabel: function closeAriaLabel() {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return _ctx.$attrs.value && _ctx.$attrs.value.length > 0 ? (openBlock(), createElementBlock("div", mergeProps({
		...
		}, $options.getPTOptions("closeButton")), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates["closeicon"] || "TimesIcon"), mergeProps({ "class": _ctx.cx("closeIcon") }, $options.getPTOptions("closeIcon")), null, 16, ["class"]))], 16, _hoisted_2)), [[_directive_ripple]]) : createCommentVNode("", true),
		_ctx.$attrs.templates && _ctx.$attrs.templates["header"] ? (openBlock(), createElementBlock("div", mergeProps({
			key: 1,
			"class": _ctx.cx("header")
		}, $options.getPTOptions("header")), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates["header"])))], 16)) : createCommentVNode("", true),
		createBaseVNode("div", mergeProps({
			...
			"pt",
			"unstyled"
		])) : createCommentVNode("", true)], 16, _hoisted_3),
		_ctx.$attrs.templates && _ctx.$attrs.templates["footer"] ? (openBlock(), createElementBlock("div", mergeProps({
			key: 2,
			"class": _ctx.cx("footer")
		}, $options.getPTOptions("footer")), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates["footer"])))], 16)) : createCommentVNode("", true)
...
var script = {
	...
	updated: function updated() {
		if (this.fullScreen && this.visible) this.containerVisible = this.visible;
	},
	beforeUnmount: function beforeUnmount() {
		if (this.fullScreen) unblockBodyScroll();
		this.mask = null;
		if (this.container) {
			x.clear(this.container.$el || this.container);
			this.container = null;
		}
	},
	methods: {
		...
		onActiveItemChange: function onActiveItemChange(index) {
			if (this.activeIndex !== index) this.$emit("update:activeIndex", index);
		},
		...
		onKeyDown: function onKeyDown(event) {
			if (event.code === "Escape") this.maskHide();
		},
		...
		bindGlobalListeners: function bindGlobalListeners() {
			if (this.fullScreen) this.bindDocumentKeyDownListener();
		},
		unbindGlobalListeners: function unbindGlobalListeners() {
			if (this.fullScreen) this.unbindDocumentKeyDownListener();
		},
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return _ctx.fullScreen ? (openBlock(), createBlock(_component_Portal, { key: 0 }, {
			...
			return [$data.containerVisible ? (openBlock(), createElementBlock("div", mergeProps({
				...
				"default": withCtx(function() {
					return [_ctx.visible ? withDirectives((openBlock(), createBlock(_component_GalleriaContent, mergeProps({
						...
						"pt",
						"unstyled"
					])), [[_directive_focustrap]]) : createCommentVNode("", true)];
				}),
				_: 1
			}, 16, [
				"onBeforeEnter",
