import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, jr as toDisplayString, q as createCommentVNode, t as Transition, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { G as J, K as M, Kt as bt, Nt as S, Vt as Yt, at as l, gt as D, in as v, on as z, ot as m, sn as zt, ut as s, z as x } from "./dist-Dc7XnIxt.js";
...
import { t as script$4 } from "./portal-A_VwLjGJ.js";
import { t as script$5 } from "./angleright-BPHkkynR.js";
//#endregion
//#region ../node_modules/primevue/tieredmenu/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/tieredmenu/index.mjs
var script$2 = {
	name: "BaseTieredMenu",
	"extends": script$3,
	props: {
...
var script$1 = {
	...
	components: { AngleRightIcon: script$5 },
		...
		"default": withCtx(function() {
			return [($props.level === 0 ? true : $props.visible) ? (openBlock(), createElementBlock("ul", {
				...
				return openBlock(), createElementBlock(Fragment, { key: $options.getItemKey(processedItem) }, [$options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
					...
					}, { ref_for: true }, $options.getPTOptions(processedItem, index, "itemLabel")), toDisplayString($options.getItemLabel(processedItem)), 17, _hoisted_5),
					$options.getItemProp(processedItem, "items") ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [$props.templates.submenuicon ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.submenuicon), mergeProps({
						key: 0,
						"class": _ctx.cx("submenuIcon"),
						active: $options.isItemActive(processedItem)
					}, { ref_for: true }, $options.getPTOptions(processedItem, index, "submenuIcon")), null, 16, ["class", "active"])) : (openBlock(), createBlock(_component_AngleRightIcon, mergeProps({
						key: 1,
						"class": _ctx.cx("submenuIcon")
					...
					"label",
					"props"
				]))], 16, _hoisted_3), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_TieredMenuSub, mergeProps({
					key: 0,
					id: $options.getItemId(processedItem) + "_list",
					"class": _ctx.cx("submenu"),
					style: _ctx.sx("submenu", true, { processedItem }),
...
var script = {
	...
	methods: {
		...
		onFocus: function onFocus(event) {
			this.focused = true;
			if (!this.popup) this.focusedItemInfo = this.focusedItemInfo.index !== -1 ? this.focusedItemInfo : {
		...
		bindScrollListener: function bindScrollListener() {
			var _this3 = this;
			if (!this.scrollHandler) this.scrollHandler = new ConnectedOverlayScrollHandler(this.target, function(event) {
			...
			return [createVNode(Transition, mergeProps({
				...
				"default": withCtx(function() {
					return [$data.visible ? (openBlock(), createElementBlock("div", mergeProps({
						...
						createVNode(_component_TieredMenuSub, mergeProps({
...
//# sourceMappingURL=tieredmenu-Bx_ds7Rw.js.map