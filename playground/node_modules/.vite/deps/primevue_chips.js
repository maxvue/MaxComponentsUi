import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, N as Fragment, Ot as mergeProps, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, tt as createVNode } from "./runtime-dom.esm-bundler-mXmJYp7I.js";
import "./vue.js";
...
//#endregion
//#region node_modules/primevue/inputchips/style/index.mjs
var InputChipsStyle = BaseStyle.extend({
	...
	classes: {
		...
		input: function input(_ref2) {
			...
			return ["p-inputchips-input", { "p-variant-filled": props.variant ? props.variant === "filled" : instance.$primevue.config.inputStyle === "filled" || instance.$primevue.config.inputVariant === "filled" }];
		},
		chipItem: function chipItem(_ref3) {
			var state = _ref3.state, index = _ref3.index;
			return ["p-inputchips-chip-item", { "p-focus": state.focusedIndex === index }];
		},
...
//#endregion
//#region node_modules/primevue/inputchips/index.mjs
var script$1 = {
	name: "BaseInputChips",
	"extends": script$3,
	props: {
...
var script$2 = {
	...
	methods: {
		...
		onBlur: function onBlur(event) {
			this.focused = false;
			this.focusedIndex = null;
			if (this.addOnBlur) this.addItem(event, event.target.value, false);
		...
		onKeyDown: function onKeyDown(event) {
			...
			switch (event.code) {
				case "Backspace":
					if (inputValue.length === 0 && this.modelValue && this.modelValue.length > 0) if (this.focusedIndex !== null) this.removeItem(event, this.focusedIndex);
					else this.removeItem(event, this.modelValue.length - 1);
					break;
				case "Enter":
				case "NumpadEnter":
					if (inputValue && inputValue.trim().length && !this.maxedOut) this.addItem(event, inputValue, true);
					break;
				case "ArrowLeft":
					if (inputValue.length === 0 && this.modelValue && this.modelValue.length > 0) this.$refs.container.focus();
					break;
				case "ArrowRight":
				...
				default:
					if (this.separator) {
						if (this.separator === event.key || event.key.match(this.separator)) this.addItem(event, inputValue, true);
					}
					break;
			}
		},
		...
		onArrowRightKeyOn: function onArrowRightKeyOn() {
			if (this.inputValue.length === 0 && this.modelValue && this.modelValue.length > 0) if (this.focusedIndex === this.modelValue.length - 1) {
				this.focusedIndex = null;
				this.$refs.input.focus();
			} else this.focusedIndex++;
		},
		onBackspaceKeyOn: function onBackspaceKeyOn(event) {
			if (this.focusedIndex !== null) this.removeItem(event, this.focusedIndex);
		},
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [createBaseVNode("ul", mergeProps({
		...
		return openBlock(), createElementBlock("li", mergeProps({
			...
			role: "option",
			"class": _ctx.cx("chipItem", { index: i }),
			"aria-label": val,
			"aria-selected": true,
			"aria-setsize": _ctx.modelValue.length,
			"aria-posinset": i + 1
		}, { ref_for: true }, _ctx.ptm("chipItem"), { "data-p-focused": $data.focusedIndex === i }), [renderSlot(_ctx.$slots, "chip", {
...
//#endregion
//#region node_modules/primevue/chips/index.mjs
var script = {
	name: "Chips",
	"extends": script$2,
	mounted: function mounted() {
