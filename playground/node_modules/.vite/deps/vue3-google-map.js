import { Ar as slotFlagsText, Cr as isVoidTag, Fr as __exportAll, Lr as __toCommonJS, Mr as toHandlerKey, Nr as __commonJSMin, Or as parseStringStyle, Pr as __esmMin, Sr as isSymbol, _r as isObject, ar as NO, br as isSVGTag, cr as camelize, dr as generateCodeFrame, fr as init_shared_esm_bundler, gr as isMathMLTag, hr as isHTMLTag, ir as EMPTY_OBJ, kr as shared_esm_bundler_exports, lr as capitalize, m as runtime_dom_esm_bundler_exports, mr as isBuiltInDirective, or as NOOP, pr as isArray, sr as PatchFlagNames, u as init_runtime_dom_esm_bundler, ur as extend, vr as isOn, wr as makeMap, xr as isString, yr as isReservedProp } from "./runtime-dom.esm-bundler-C69FAPN8.js";
...
//#endregion
//#region ../node_modules/vue3-google-map/dist/index.umd.js
var require_index_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function() {
		...
		try {
			if (typeof document < "u") {
				...
				a.nonce = (e = document.head.querySelector("meta[property=csp-nonce]")) == null ? void 0 : e.content, a.appendChild(document.createTextNode(".mapdiv[data-v-0f97a681]{width:100%;height:100%}.advanced-marker-wrapper{display:none}.mapdiv .advanced-marker-wrapper{display:inline-block}.custom-control-wrapper[data-v-ae91c15f]{display:none}.mapdiv .custom-control-wrapper[data-v-ae91c15f]{display:inline-block}.info-window-wrapper[data-v-fdd87cf3]{display:none}.mapdiv .info-window-wrapper[data-v-fdd87cf3]{display:inline-block}.custom-marker-wrapper[data-v-90fe8380]{display:none}.mapdiv .custom-marker-wrapper[data-v-90fe8380]{display:inline-block}")), document.head.appendChild(a);
			}
		} catch (d) {
	...
	(function(w, l) {
		typeof exports == "object" && typeof module < "u" ? l(exports, require_vue()) : typeof define == "function" && define.amd ? define(["exports", "vue"], l) : (w = typeof globalThis < "u" ? globalThis : w || self, l(w.Vue3GoogleMap = {}, w.Vue));
	})(exports, function(w, l) {
		"use strict";
		var gn = Object.defineProperty;
		var yn = (w, l, M) => l in w ? gn(w, l, {
			enumerable: !0,
			configurable: !0,
			writable: !0,
			value: M
		}) : w[l] = M;
		var re = (w, l, M) => (yn(w, typeof l != "symbol" ? l + "" : l, M), M);
		const M = Symbol("map"), A = Symbol("api"), ne = Symbol("marker"), oe = Symbol("markerCluster"), W = Symbol("CustomMarker"), se = Symbol("mapTilesLoaded"), B = [
			"click",
			"dblclick",
			"drag",
			"dragend",
		...
		const tt = (t) => {
			var e, r, n, o = "The Google Maps JavaScript API", s = "google", i = "importLibrary", c = "__ib__", a = document, d = window, p = d[s] || (d[s] = {}), u = p.maps || (p.maps = {}), m = /* @__PURE__ */ new Set(), h = new URLSearchParams(), g = () => e || (e = new Promise(async (f, y) => {
				var v;
				await (r = a.createElement("script")), h.set("libraries", [...m] + "");
				for (n in t) h.set(n.replace(/[A-Z]/g, (k) => "_" + k[0].toLowerCase()), t[n]);
				h.set("callback", s + ".maps." + c), et(r, "https://maps.googleapis.com/maps/api/js?" + h), u[c] = f, r.onerror = () => e = y(Error(o + " could not load.")), r.nonce = ((v = a.querySelector("script[nonce]")) == null ? void 0 : v.nonce) || "", a.head.append(r);
			}));
			u[i] ? console.warn(o + " only loads once. Ignoring:", t) : u[i] = (f, ...y) => m.add(f) && g().then(() => u[i](f, ...y));
		}, rt = (t) => `The setOptions() function should only be called once. The options passed to the additional call (${JSON.stringify(t)}) will be ignored.`, nt = (t) => `The google.maps.importLibrary() function is already defined, and @googlemaps/js-api-loader will use the existing function instead of overwriting it. The options passed to setOptions (${JSON.stringify(t)}) will be ignored.`, ot = "No options were set before calling importLibrary. Make sure to configure the loader using setOptions().", st = "There already is a script loading the Google Maps JavaScript API, and no google.maps.importLibrary function is defined. @googlemaps/js-api-loader will proceed to bootstrap the API with the specified options, but the existing script might cause problems using the API. Make sure to remove the script loading the API.", ae = (t) => {
		...
		async function lt(t) {
			var e, r;
			if (ie || ae(ot), !((r = (e = window == null ? void 0 : window.google) == null ? void 0 : e.maps) != null && r.importLibrary)) throw new Error("google.maps.importLibrary is not installed.");
			return await google.maps.importLibrary(t);
		}
		function ct(t) {
			var r, n;
			const e = !!((n = (r = window.google) == null ? void 0 : r.maps) != null && n.importLibrary);
			e ? at(nt(t)) : document.querySelector("script[src*=\"maps.googleapis.com/maps/api/js\"]") && ae(st), e || tt(t);
		}
		function ut(t) {
			return class extends t.OverlayView {
				...
				getVisible() {
					...
					return n.style.display !== "none" && n.style.visibility !== "hidden" && (n.style.opacity === "" || Number(n.style.opacity) > .01);
				}
				onAdd() {
		...
		const ve = [
			...
			emits: [...ve],
			setup(t, { emit: e }) {
				const r = l.ref(), n = l.ref(!1), o = l.ref(), s = l.ref(), i = l.ref(!1);
				l.provide(M, o), l.provide(A, s), l.provide(se, i);
				const c = () => {
					const u = { ...t };
					...
					s.value = l.markRaw(m), o.value = l.markRaw(new m.Map(r.value, c()));
					const h = ut(s.value);
					s.value[W] = h, ve.forEach((f) => {
						var y;
						(y = o.value) == null || y.addListener(f, (v) => e(f, v));
					}), n.value = !0;
					const g = Object.keys(t).filter((f) => ![
						"apiPromise",
						"apiKey",
						"version",
						"libraries",
					...
					l.watch([
						...
						(C = o.value) == null || C.setOptions(O), y !== void 0 && y !== k && ((S = o.value) == null || S.setZoom(y));
				...
				return l.onMounted(() => {
					if (t.apiPromise && t.apiPromise instanceof Promise) t.apiPromise.then(p);
						...
						Promise.all(u.map((m) => lt(m))).then(() => p());
					}
				}), l.onBeforeUnmount(() => {
					var u;
					i.value = !1, o.value && ((u = s.value) == null || u.event.clearInstanceListeners(o.value));
				}), {
					mapRef: r,
					ready: n,
					map: o,
		...
		function pt(t, e, r, n, o, s) {
			return l.openBlock(), l.createElementBlock("div", null, [l.createElementVNode("div", ft, null, 512), l.renderSlot(t.$slots, "default", l.normalizeProps(l.guardReactiveProps({
				ready: t.ready,
				map: t.map,
				api: t.api,
				mapTilesLoaded: t.mapTilesLoaded
			})), void 0, !0)]);
		}
		const mt = D(dt, [["render", pt], ["__scopeId", "data-v-0f97a681"]]);
		function ht(t) {
			return t && t.__esModule && Object.prototype.hasOwnProperty.call(t, "default") ? t.default : t;
		}
		const V = ht(function t(e, r) {
			if (e === r) return !0;
			...
			return e !== e && r !== r;
		}), ke = "click", Ee = "gmp-click", we = [
			"drag",
			"dragend",
			"dragstart",
			Ee
		], yt = l.defineComponent({
			name: "AdvancedMarker",
			props: {
				options: {
					type: Object,
			...
			setup(t, { emit: e, expose: r, slots: n }) {
				...
				}), i = l.toRef(t, "options"), c = l.toRef(t, "pinOptions"), a = l.ref(), d = l.inject(M, l.ref()), p = l.inject(A, l.ref()), u = l.inject(oe, l.ref()), m = l.computed(() => !!(u.value && p.value && a.value instanceof google.maps.marker.AdvancedMarkerElement));
				return l.watch([
					d,
					i,
					c,
					...
					var C, S, x;
					const k = !V(i.value, f) || !V(c.value, y), _ = o.value !== v, T = k || _ || d.value !== g;
					if (!d.value || !p.value || !T || s.value && !o.value) return;
					const { AdvancedMarkerElement: O, PinElement: E } = p.value.marker;
					if (a.value) {
						const { map: Q, content: ee, ...te } = i.value;
						Object.assign(a.value, {
							content: s.value ? o.value : c.value ? new E(c.value) : ee,
							...te
						}), m.value && ((C = u.value) == null || C.removeMarker(a.value), (S = u.value) == null || S.addMarker(a.value));
					} else s.value ? i.value.content = o.value : c.value && (i.value.content = new E(c.value)), a.value = l.markRaw(new O(i.value)), m.value ? (x = u.value) == null || x.addMarker(a.value) : a.value.map = d.value, we.forEach((Q) => {
						var ee;
						(ee = a.value) == null || ee.addListener(Q, (te) => {
							e(Q, te), Q === Ee && e(ke, te);
						});
					});
				}, {
				...
				}), l.provide(ne, a), r({ marker: a }), {
					hasCustomSlotContent: s,
					markerRef: o
				};
			}
		}), vt = {
		...
		function kt(t, e, r, n, o, s) {
			return l.openBlock(), l.createElementBlock(l.Fragment, null, [t.hasCustomSlotContent ? (l.openBlock(), l.createElementBlock("div", vt, [l.createElementVNode("div", l.mergeProps({ ref: "markerRef" }, t.$attrs), [l.renderSlot(t.$slots, "content")], 16)])) : l.createCommentVNode("v-if", !0), l.renderSlot(t.$slots, "default")], 64);
		}
		const Et = D(yt, [["render", kt]]), _e = (t) => t === "Marker", Ce = (t) => t === W, $ = (t, e, r, n) => {
			const o = l.ref(), s = l.inject(M, l.ref()), i = l.inject(A, l.ref()), c = l.inject(oe, l.ref()), a = l.computed(() => !!(c.value && i.value && (o.value instanceof i.value.Marker || o.value instanceof i.value[W])));
			return l.watch([s, r], (d, [p, u]) => {
				var h, g, f;
				const m = !V(r.value, u) || s.value !== p;
				if (!(!s.value || !i.value || !m)) if (o.value) o.value.setOptions(r.value), a.value && ((h = c.value) == null || h.removeMarker(o.value), (g = c.value) == null || g.addMarker(o.value));
				else {
					if (_e(t)) o.value = l.markRaw(new i.value[t](r.value));
					else if (Ce(t)) {
						const y = r.value;
						y.element && (o.value = l.markRaw(new i.value[t](y)));
					} else o.value = l.markRaw(new i.value[t]({
						...r.value,
						map: s.value
					}));
					o.value && (a.value ? (f = c.value) == null || f.addMarker(o.value) : (_e(t) || Ce(t)) && o.value.setMap(s.value)), e.forEach((y) => {
						var v;
						(v = o.value) == null || v.addListener(y, (k) => n(y, k));
					});
				}
			}, {
				immediate: !0,
			...
			emits: [...be],
			setup(t, { emit: e, expose: r, slots: n }) {
				const s = $("Marker", be, l.toRef(t, "options"), e);
				return l.provide(ne, s), r({ marker: s }), () => {
					var i;
					return (i = n.default) == null ? void 0 : i.call(n);
				};
			}
		}), _t = l.defineComponent({
			name: "Polyline",
			props: { options: {
				type: Object,
				required: !0
			...
			emits: [...B],
			setup(t, { emit: e }) {
				return { polyline: $("Polyline", B, l.toRef(t, "options"), e) };
			},
			render: () => null
		}), Ct = l.defineComponent({
			name: "Polygon",
			props: { options: {
				type: Object,
				required: !0
			...
			emits: [...B],
			setup(t, { emit: e }) {
				return { polygon: $("Polygon", B, l.toRef(t, "options"), e) };
			},
			render: () => null
		}), Me = [...B, "bounds_changed"], bt = l.defineComponent({
			name: "Rectangle",
			props: { options: {
				type: Object,
				required: !0
			...
			emits: [...Me],
			setup(t, { emit: e }) {
				return { rectangle: $("Rectangle", Me, l.toRef(t, "options"), e) };
			},
			render: () => null
		}), Oe = [
			...B,
			...
			emits: [...Oe],
			setup(t, { emit: e }) {
				return { circle: $("Circle", Oe, l.toRef(t, "options"), e) };
			},
			render: () => null
		}), Ot = l.defineComponent({
			props: {
				position: {
					type: String,
					required: !0
			...
			setup(t, { emit: e }) {
				const r = l.ref(null), n = l.inject(M, l.ref()), o = l.inject(A, l.ref()), s = l.inject(se, l.ref(!1)), i = l.watch([
					s,
					o,
					r
				], ([d, p, u]) => {
		...
		function Tt(t, e, r, n, o, s) {
			return l.openBlock(), l.createElementBlock(l.Fragment, null, [l.createCommentVNode(`
    v-show must be used instead of v-if otherwise there
    would be no rendered content pushed to the map controls
  `), l.createElementVNode("div", St, [l.renderSlot(t.$slots, "default", {}, void 0, !0)], 512)], 2112);
		}
		const Pt = D(Ot, [["render", Tt], ["__scopeId", "data-v-ae91c15f"]]);
		function Se(t) {
		...
		const Te = [
			...
			emits: [...Te, "update:modelValue"],
			setup(t, { slots: e, emit: r, expose: n }) {
				const o = l.ref(), s = l.ref(), i = l.inject(M, l.ref()), c = l.inject(A, l.ref()), a = l.inject(ne, l.ref());
				let d, p = t.modelValue;
				const u = l.computed(() => {
					var f;
					return (f = e.default) == null ? void 0 : f.call(e).some((y) => y.type !== l.Comment);
				}), m = (f) => {
					p = f, r("update:modelValue", f);
				}, h = (f) => {
					o.value && (o.value.open({
						map: i.value,
						anchor: a.value,
						...f
					}), m(!0));
				}, g = () => {
					o.value && (o.value.close(), m(!1));
				};
				return l.onMounted(() => {
					l.watch([i, () => t.options], ([f, y], [v, k]) => {
						var T;
						const _ = !V(y, k) || i.value !== v;
						i.value && c.value && _ && (o.value ? (o.value.setOptions({
							...y,
							content: u.value ? s.value : y.content
						}), a.value || h()) : (o.value = l.markRaw(new c.value.InfoWindow({
							...y,
							content: u.value ? s.value : y.content
						})), a.value && (d = a.value.addListener(Se(a.value), () => h())), (!a.value || p) && h(), Te.forEach((O) => {
							var E;
							(E = o.value) == null || E.addListener(O, (C) => r(O, C));
						}), (T = o.value) == null || T.addListener("closeclick", () => m(!1))));
					}, {
						immediate: !0,
						flush: "post"
					}), l.watch(a, (f, y) => {
						!o.value || f === y || (d && (d.remove(), d = void 0), f && (d = f.addListener(Se(f), () => h())));
		...
		function Lt(t, e, r, n, o, s) {
			return t.hasSlotContent ? (l.openBlock(), l.createElementBlock("div", qt, [l.createElementVNode("div", l.mergeProps({ ref: "infoWindowRef" }, t.$attrs), [l.renderSlot(t.$slots, "default", {}, void 0, !0)], 16)])) : l.createCommentVNode("v-if", !0);
		}
		const jt = D(At, [["render", Lt], ["__scopeId", "data-v-fdd87cf3"]]);
		var Rt = Object.getOwnPropertyNames, xt = Object.getOwnPropertySymbols, It = Object.prototype.hasOwnProperty;
		function Pe(t, e) {
		...
		function H(t) {
			return function(r, n, o) {
				if (!r || !n || typeof r != "object" || typeof n != "object") return t(r, n, o);
				var s = o.cache, i = s.get(r), c = s.get(n);
		...
		function Ae(t) {
			return Rt(t).concat(xt(t));
		}
		var Nt = Object.hasOwn || function(t, e) {
			return It.call(t, e);
		};
		function I(t, e) {
			return t === e || !t && !e && t !== t && e !== e;
		}
		var Bt = "__v", $t = "__o", Dt = "_owner", qe = Object.getOwnPropertyDescriptor, Le = Object.keys;
		function Vt(t, e, r) {
			var n = t.length;
		...
		function je(t, e, r) {
			...
			for (var o = new Array(n), s = t.entries(), i, c, a = 0; (i = s.next()) && !i.done;) {
				for (var d = e.entries(), p = !1, u = 0; (c = d.next()) && !c.done;) {
					if (o[u]) {
						u++;
						continue;
					}
					var m = i.value, h = c.value;
					if (r.equals(m[0], h[0], a, u, t, e, r) && r.equals(m[1], h[1], m[0], h[0], t, e, r)) {
						p = o[u] = !0;
						break;
					}
					u++;
		...
		var Ft = I;
		function zt(t, e, r) {
			var n = Le(t), o = n.length;
			if (Le(e).length !== o) return !1;
			for (; o-- > 0;) if (!xe(t, e, r, n[o])) return !1;
			return !0;
		}
		function U(t, e, r) {
			var n = Ae(t), o = n.length;
			if (Ae(e).length !== o) return !1;
			for (var s, i, c; o-- > 0;) if (s = n[o], !xe(t, e, r, s) || (i = qe(t, s), c = qe(e, s), (i || c) && (!i || !c || i.configurable !== c.configurable || i.enumerable !== c.enumerable || i.writable !== c.writable))) return !1;
			return !0;
		}
		function Wt(t, e) {
		...
		function Re(t, e, r) {
			...
			for (var o = new Array(n), s = t.values(), i, c; (i = s.next()) && !i.done;) {
				for (var a = e.values(), d = !1, p = 0; (c = a.next()) && !c.done;) {
					if (!o[p] && r.equals(i.value, c.value, i.value, c.value, t, e, r)) {
						d = o[p] = !0;
						break;
					}
					p++;
		...
		function xe(t, e, r, n) {
			return (n === Dt || n === $t || n === Bt) && (t.$$typeof || e.$$typeof) ? !0 : Nt(e, n) && r.equals(t[n], e[n], n, n, t, e, r);
		}
		var Yt = "[object Arguments]", Jt = "[object Boolean]", Qt = "[object Date]", er = "[object Error]", tr = "[object Map]", rr = "[object Number]", nr = "[object Object]", or = "[object RegExp]", sr = "[object Set]", ar = "[object String]", ir = "[object URL]", lr = Array.isArray, Ie = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Ne = Object.assign, cr = Object.prototype.toString.call.bind(Object.prototype.toString);
		function ur(t) {
			var e = t.areArraysEqual, r = t.areDatesEqual, n = t.areErrorsEqual, o = t.areFunctionsEqual, s = t.areMapsEqual, i = t.areNumbersEqual, c = t.areObjectsEqual, a = t.arePrimitiveWrappersEqual, d = t.areRegExpsEqual, p = t.areSetsEqual, u = t.areTypedArraysEqual, m = t.areUrlsEqual;
			return function(g, f, y) {
				if (g === f) return !0;
				if (g == null || f == null) return !1;
				var v = typeof g;
				if (v !== typeof f) return !1;
				if (v !== "object") return v === "number" ? i(g, f, y) : v === "function" ? o(g, f, y) : !1;
				var k = g.constructor;
				if (k !== f.constructor) return !1;
				if (k === Object) return c(g, f, y);
				if (lr(g)) return e(g, f, y);
				if (Ie != null && Ie(g)) return u(g, f, y);
				if (k === Date) return r(g, f, y);
				if (k === RegExp) return d(g, f, y);
				if (k === Map) return s(g, f, y);
				if (k === Set) return p(g, f, y);
				var _ = cr(g);
				return _ === Qt ? r(g, f, y) : _ === or ? d(g, f, y) : _ === tr ? s(g, f, y) : _ === sr ? p(g, f, y) : _ === nr ? typeof g.then != "function" && typeof f.then != "function" && c(g, f, y) : _ === ir ? m(g, f, y) : _ === er ? n(g, f, y) : _ === Yt ? c(g, f, y) : _ === Jt || _ === rr || _ === ar ? a(g, f, y) : !1;
			};
		}
		function dr(t) {
			var e = t.circular, r = t.createCustomConfig, n = t.strict, o = {
				areArraysEqual: n ? U : Vt,
				areDatesEqual: Ut,
				areErrorsEqual: Zt,
				areFunctionsEqual: Gt,
				areMapsEqual: n ? Pe(je, U) : je,
				areNumbersEqual: Ft,
				areObjectsEqual: n ? U : zt,
				arePrimitiveWrappersEqual: Wt,
				areRegExpsEqual: Ht,
				areSetsEqual: n ? Pe(Re, U) : Re,
				areTypedArraysEqual: n ? U : Kt,
				areUrlsEqual: Xt
			};
			if (r && (o = Ne({}, o, r(o))), e) {
		...
		function fr(t) {
			return function(e, r, n, o, s, i, c) {
				return t(e, r, c);
			};
		}
		function pr(t) {
			var e = t.circular, r = t.comparator, n = t.createState, o = t.equals, s = t.strict;
		...
		function q(t) {
			t === void 0 && (t = {});
			var e = t.circular, r = e === void 0 ? !1 : e, n = t.createInternalComparator, o = t.createState, s = t.strict, i = s === void 0 ? !1 : s, a = ur(dr(t));
			return pr({
				circular: r,
				comparator: a,
				createState: o,
		...
		class ce {
			...
			constructor(e, r = 64, n = Float64Array, o) {
				...
				const s = Be.indexOf(this.ArrayType), i = e * 2 * this.ArrayType.BYTES_PER_ELEMENT, c = e * this.IndexArrayType.BYTES_PER_ELEMENT, a = (8 - c % 8) % 8;
				if (s < 0) throw new Error(`Unexpected typed array class: ${n}.`);
				o && o instanceof ArrayBuffer ? (this.data = o, this.ids = new this.IndexArrayType(this.data, Z, e), this.coords = new this.ArrayType(this.data, Z + c + a, e * 2), this._pos = e * 2, this._finished = !0) : (this.data = new ArrayBuffer(Z + i + c + a), this.ids = new this.IndexArrayType(this.data, Z, e), this.coords = new this.ArrayType(this.data, Z + c + a, e * 2), this._pos = 0, this._finished = !1, new Uint8Array(this.data, 0, 2).set([219, (le << 4) + s]), new Uint16Array(this.data, 2, 1)[0] = r, new Uint32Array(this.data, 4, 1)[0] = e);
			}
			add(e, r) {
				const n = this._pos >> 1;
			...
			range(e, r, n, o) {
				...
				const { ids: s, coords: i, nodeSize: c } = this, a = [
					0,
					s.length - 1,
					0
				], d = [];
				for (; a.length;) {
					...
					if (u - m <= c) {
						for (let y = m; y <= u; y++) {
							const v = i[2 * y], k = i[2 * y + 1];
							v >= e && v <= n && k >= r && k <= o && d.push(s[y]);
						}
						continue;
					}
					const h = m + u >> 1, g = i[2 * h], f = i[2 * h + 1];
					g >= e && g <= n && f >= r && f <= o && d.push(s[h]), (p === 0 ? e <= g : r <= f) && (a.push(m), a.push(h - 1), a.push(1 - p)), (p === 0 ? n >= g : o >= f) && (a.push(h + 1), a.push(u), a.push(1 - p));
				}
				return d;
			}
			within(e, r, n) {
				if (!this._finished) throw new Error("Data not yet indexed - call index.finish().");
				const { ids: o, coords: s, nodeSize: i } = this, c = [
					0,
					o.length - 1,
					0
				], a = [], d = n * n;
				for (; c.length;) {
					...
					if (u - m <= i) {
						for (let y = m; y <= u; y++) De(s[2 * y], s[2 * y + 1], e, r) <= d && a.push(o[y]);
						continue;
					}
					const h = m + u >> 1, g = s[2 * h], f = s[2 * h + 1];
					De(g, f, e, r) <= d && a.push(o[h]), (p === 0 ? e - n <= g : r - n <= f) && (c.push(m), c.push(h - 1), c.push(1 - p)), (p === 0 ? e + n >= g : r + n >= f) && (c.push(h + 1), c.push(u), c.push(1 - p));
				}
				return a;
			}
		}
		function ue(t, e, r, n, o, s) {
			if (o - n <= r) return;
			const i = n + o >> 1;
			$e(t, e, i, n, o, s), ue(t, e, r, n, i - 1, 1 - s), ue(t, e, r, i + 1, o, 1 - s);
		}
		function $e(t, e, r, n, o, s) {
			for (; o > n;) {
				if (o - n > 600) {
					const d = o - n + 1, p = r - n + 1, u = Math.log(d), m = .5 * Math.exp(2 * u / 3), h = .5 * Math.sqrt(u * m * (d - m) / d) * (p - d / 2 < 0 ? -1 : 1);
					$e(t, e, r, Math.max(n, Math.floor(r - p * m / d + h)), Math.min(o, Math.floor(r + (d - p) * m / d + h)), s);
				}
				const i = e[2 * r + s];
				let c = n, a = o;
				for (G(t, e, n, r), e[2 * o + s] > i && G(t, e, n, o); c < a;) {
					for (G(t, e, c, a), c++, a--; e[2 * c + s] < i;) c++;
					for (; e[2 * a + s] > i;) a--;
				}
				e[2 * n + s] === i ? G(t, e, n, a) : (a++, G(t, e, a, o)), a <= r && (n = a + 1), r <= a && (o = a - 1);
			}
		}
		function G(t, e, r, n) {
			de(t, r, n), de(e, 2 * r, 2 * n), de(e, 2 * r + 1, 2 * n + 1);
		}
		function de(t, e, r) {
			const n = t[e];
			t[e] = t[r], t[r] = n;
		...
		const mr = {
			...
			reduce: null,
			map: (t) => t
		}, Ve = Math.fround || ((t) => (e) => (t[0] = +e, t[0]))(new Float32Array(1)), N = 2, L = 3, fe = 4, j = 5, Ue = 6;
		class Ze {
			constructor(e) {
				this.options = Object.assign(Object.create(mr), e), this.trees = new Array(this.options.maxZoom + 1), this.stride = this.options.reduce ? 7 : 6, this.clusterProps = [];
			}
			load(e) {
				...
				for (let a = 0; a < e.length; a++) {
					...
					const [p, u] = d.geometry.coordinates, m = Ve(X(p)), h = Ve(Y(u));
					i.push(m, h, Infinity, a, -1, 1), this.options.reduce && i.push(0);
				}
				let c = this.trees[o + 1] = this._createTree(i);
				r && console.timeEnd(s);
				for (let a = o; a >= n; a--) {
					const d = +Date.now();
					c = this.trees[a] = this._createTree(this._cluster(c, a)), r && console.log("z%d: %d clusters in %dms", a, c.numItems, +Date.now() - d);
				}
			...
			getClusters(e, r) {
				...
				const c = this.trees[this._limitZoom(r)], a = c.range(X(n), Y(i), X(s), Y(o)), d = c.data, p = [];
				for (const u of a) {
					const m = this.stride * u;
					p.push(d[m + j] > 1 ? Ge(d, m, this.clusterProps) : this.points[d[m + L]]);
				}
				return p;
			}
			getChildren(e) {
				...
				const i = s.data;
				if (r * this.stride >= i.length) throw new Error(o);
				const c = this.options.radius / (this.options.extent * Math.pow(2, n - 1)), a = i[r * this.stride], d = i[r * this.stride + 1], p = s.within(a, d, c), u = [];
				for (const m of p) {
					const h = m * this.stride;
					i[h + fe] === e && u.push(i[h + j] > 1 ? Ge(i, h, this.clusterProps) : this.points[i[h + L]]);
				}
			...
			getTile(e, r, n) {
				...
				return this._addTileFeatures(o.range((r - a) / s, d, (r + 1 + a) / s, p), o.data, r, n, s, u), r === 0 && this._addTileFeatures(o.range(1 - a / s, d, 1, p), o.data, s, n, s, u), r === s - 1 && this._addTileFeatures(o.range(0, d, a / s, p), o.data, -1, n, s, u), u.features.length ? u : null;
			}
			...
			_createTree(e) {
				const r = new ce(e.length / this.stride | 0, this.options.nodeSize, Float32Array);
				for (let n = 0; n < e.length; n += this.stride) r.add(e[n], e[n + 1]);
				return r.finish(), r.data = e, r;
			}
			_addTileFeatures(e, r, n, o, s, i) {
				for (const c of e) {
					const a = c * this.stride, d = r[a + j] > 1;
					let p, u, m;
					if (d) p = Fe(r, a, this.clusterProps), u = r[a], m = r[a + 1];
					else {
						const f = this.points[r[a + L]];
						p = f.properties;
					...
					const h = {
						type: 1,
						geometry: [[Math.round(this.options.extent * (u * s - n)), Math.round(this.options.extent * (m * s - o))]],
						tags: p
					};
					let g;
					d || this.options.generateId ? g = r[a + L] : g = this.points[r[a + L]].id, g !== void 0 && (h.id = g), i.features.push(h);
				}
			}
			_limitZoom(e) {
			...
			_cluster(e, r) {
				const { radius: n, extent: o, reduce: s, minPoints: i } = this.options, c = n / (o * Math.pow(2, r)), a = e.data, d = [], p = this.stride;
				for (let u = 0; u < a.length; u += p) {
					...
					if (y > f && y >= i) {
						...
						for (const E of g) {
							...
							a[C + N] = r;
							const S = a[C + j];
							v += a[C] * S, k += a[C + 1] * S, a[C + fe] = O, s && (_ || (_ = this._map(a, u, !0), T = this.clusterProps.length, this.clusterProps.push(_)), s(_, this._map(a, C)));
						}
						a[u + fe] = O, d.push(v / y, k / y, Infinity, O, -1, y), s && d.push(T);
					} else {
						...
						if (y > 1) for (const v of g) {
							...
							if (!(a[k + N] <= r)) {
								a[k + N] = r;
								for (let _ = 0; _ < p; _++) d.push(a[k + _]);
							}
						}
					}
				}
			...
			_map(e, r, n) {
				if (e[r + j] > 1) {
					const i = this.clusterProps[e[r + Ue]];
					return n ? Object.assign({}, i) : i;
				}
				const o = this.points[e[r + L]].properties, s = this.options.map(o);
		...
		function Ge(t, e, r) {
			return {
				...
				geometry: {
					type: "Point",
					coordinates: [hr(t[e]), gr(t[e + 1])]
				}
			};
		}
		function Fe(t, e, r) {
			const n = t[e + j], o = n >= 1e4 ? `${Math.round(n / 1e3)}k` : n >= 1e3 ? `${Math.round(n / 100) / 10}k` : n, s = t[e + Ue], i = s === -1 ? {} : Object.assign({}, r[s]);
		...
		class F {
			...
			get bounds() {
				...
				for (const r of this.markers) e.extend(b.getPosition(r));
				return e;
			}
			get position() {
		...
		const yr = (t, e, r, n) => {
			...
			P(o);
			const s = ze(o, e, n);
			return r.filter((i) => s.contains(b.getPosition(i)));
		}, ze = (t, e, r) => {
			const { northEast: n, southWest: o } = kr(t, e);
			return wr(Er({
				northEast: n,
				southWest: o
			}, r), e);
		}, vr = (t, e, r) => {
			const n = ze(t, e, r), o = n.getNorthEast(), s = n.getSouthWest();
			return [
				s.lng(),
				s.lat(),
				o.lng(),
		...
		}, Er = ({ northEast: t, southWest: e }, r) => (t.x += r, t.y -= r, e.x -= r, e.y += r, {
			northEast: t,
			southWest: e
		}), wr = ({ northEast: t, southWest: e }, r) => {
		...
		class _r extends We {
			...
			calculate({ markers: e, map: r, mapCanvasProjection: n }) {
				const o = r.getZoom();
				return P(o), o >= this.maxZoom ? {
					clusters: this.noop({ markers: e }),
					changed: !1
				} : { clusters: this.cluster({
					markers: yr(r, n, e, this.viewportPadding),
					map: r,
					mapCanvasProjection: n
				}) };
			}
		}
		const Cr = (t) => t.map((r) => new F({
		...
		class br extends We {
			constructor(e) {
				...
				super({ maxZoom: r }), this.markers = [], this.clusters = [], this.state = { zoom: -1 }, this.superCluster = new Ze(Object.assign({
			...
			calculate(e) {
				...
				return r || (this.state.zoom <= this.maxZoom || o.zoom <= this.maxZoom) && (r = !K(this.state, o)), this.state = o, e.markers.length === 0 ? (this.clusters = [], {
					clusters: this.clusters,
					changed: r
				}) : (r && (this.clusters = this.cluster(e)), {
					clusters: this.clusters,
					changed: r
				});
			}
			cluster({ map: e }) {
				const r = e.getZoom();
				return P(r), this.superCluster.getClusters([
					-180,
					-90,
					180,
					90
				], Math.round(r)).map((n) => this.transformCluster(n));
			}
			transformCluster({ geometry: { coordinates: [e, r] }, properties: n }) {
				if (n.cluster) return new F({
					markers: this.superCluster.getLeaves(n.cluster_id, Infinity).map((s) => s.properties.marker),
					position: {
						lat: r,
						lng: e
					}
				...
				return new F({
					markers: [o],
					position: b.getPosition(o)
				});
			}
		}
		class Mr extends _r {
			constructor(e) {
				var { maxZoom: r, radius: n = 60, viewportPadding: o = 60 } = e, s = pe(e, [
					"maxZoom",
					"radius",
					"viewportPadding"
				]);
				super({
					maxZoom: r,
					viewportPadding: o
				}), this.markers = [], this.clusters = [], this.superCluster = new Ze(Object.assign({
					maxZoom: this.maxZoom,
					radius: n
				}, s)), this.state = {
					zoom: -1,
			...
			calculate(e) {
				...
				return n && (this.clusters = this.cluster(e), this.state = r), {
					clusters: this.clusters,
					changed: n
				};
			}
...
<text x="50%" y="50%" style="fill:#fff" text-anchor="middle" font-size="50" dominant-baseline="middle" font-family="roboto,arial,sans-serif">${e}</text>
		...
		class Ar extends me {
			constructor({ map: e, markers: r = [], algorithmOptions: n = {}, algorithm: o = new br(n), renderer: s = new Sr(), onClusterClick: i = Pr }) {
			...
			render() {
				...
				if (e instanceof google.maps.Map && e.getProjection()) {
					...
					if (n || n == null) {
						...
						for (const i of r) i.markers.length == 1 && o.add(i.markers[0]);
						const s = [];
						for (const i of this.clusters) i.marker != null && (i.markers.length == 1 ? o.has(i.marker) || b.setMap(i.marker, null) : s.push(i.marker));
						this.clusters = r, this.renderClusters(), requestAnimationFrame(() => s.forEach((i) => b.setMap(i, null)));
					}
			...
			renderClusters() {
				const e = new Or(this.markers, this.clusters), r = this.getMap();
				this.clusters.forEach((n) => {
					if (n.markers.length === 1) n.marker = n.markers[0];
					else if (n.marker = this.renderer.render(n, e, r), n.markers.forEach((o) => b.setMap(o, null)), this.onClusterClick) {
						const o = b.isAdvancedMarker(n.marker) ? R.GMP_CLICK : R.CLUSTER_CLICK;
						n.marker.addListener(o, (s) => {
							google.maps.event.trigger(this, R.CLUSTER_CLICK, n), this.onClusterClick(s, n, r);
						});
					}
					b.setMap(n.marker, r);
				});
		...
		const Lr = typeof global == "object" && global && global.Object === Object && global;
		var jr = typeof self == "object" && self && self.Object === Object && self;
		const He = Lr || jr || Function("return this")();
		var xr = function() {
			return He.Date.now();
		};
		const ge = xr;
		...
		var Br = /^\s+/;
		function $r(t) {
			return t && t.slice(0, Nr(t) + 1).replace(Br, "");
		}
		const J = He.Symbol;
		var Ke = Object.prototype, Vr = Ke.hasOwnProperty, Ur = Ke.toString, z = J ? J.toStringTag : void 0;
		function Zr(t) {
			var e = Vr.call(t, z), r = t[z];
			try {
				t[z] = void 0;
				var n = !0;
			} catch {}
		...
		var Wr = "[object Null]", Hr = "[object Undefined]", Xe = J ? J.toStringTag : void 0;
		function Kr(t) {
			return t == null ? t === void 0 ? Hr : Wr : Xe && Xe in Object(t) ? Zr(t) : zr(t);
		}
		function Xr(t) {
		...
		function Jr(t) {
			return typeof t == "symbol" || Xr(t) && Kr(t) == Yr;
		}
		var Ye = NaN, Qr = /^[-+]0x[0-9a-f]+$/i, en = /^0b[01]+$/i, tn = /^0o[0-7]+$/i, rn = parseInt;
		function Je(t) {
			...
			t = $r(t);
			var r = en.test(t);
			return r || tn.test(t) ? rn(t.slice(2), r ? 2 : 8) : Qr.test(t) ? Ye : +t;
		}
		var nn = "Expected a function", on = Math.max, sn = Math.min;
		function an(t, e, r) {
			var n, o, s, i, c, a, d = 0, p = !1, u = !1, m = !0;
			if (typeof t != "function") throw new TypeError(nn);
			e = Je(e) || 0, he(r) && (p = !!r.leading, u = "maxWait" in r, s = u ? on(Je(r.maxWait) || 0, e) : s, m = "trailing" in r ? !!r.trailing : m);
			function h(E) {
				var C = n, S = o;
		...
		class ln extends Ar {
			constructor(r, n = 10) {
				super(r);
				re(this, "debouncedRender");
				this.debouncedRender = an(() => {
					super.render();
				}, n, {
					leading: !0,
					trailing: !0
		...
		const Qe = Object.values(R), un = l.defineComponent({
			name: "MarkerCluster",
			props: {
				options: {
					type: Object,
			...
			setup(t, { emit: e, expose: r, slots: n }) {
				...
				return l.provide(oe, o), l.watch(s, () => {
					s.value && (o.value = l.markRaw(new ln({
						map: s.value,
						algorithm: new cn(t.options.algorithmOptions ?? {}),
						...t.options
					}, t.renderDebounceDelay)), Qe.forEach((c) => {
						var a;
						(a = o.value) == null || a.addListener(c, (d) => e(c, d));
					}));
				}, { immediate: !0 }), l.onBeforeUnmount(() => {
					var c;
					o.value && ((c = i.value) == null || c.event.clearInstanceListeners(o.value), o.value.clearMarkers(!0), o.value.setMap(null), o.value.destroy());
				}), r({ markerCluster: o }), () => {
					var c;
					return (c = n.default) == null ? void 0 : c.call(n);
				};
			}
		}), dn = l.defineComponent({
			inheritAttrs: !1,
			props: { options: {
				type: Object,
				required: !0
		...
		function pn(t, e, r, n, o, s) {
			return t.hasSlotContent ? (l.openBlock(), l.createElementBlock("div", fn, [l.createElementVNode("div", l.mergeProps({
				ref: "customMarkerRef",
				style: { cursor: t.$attrs.onClick ? "pointer" : void 0 }
			}, t.$attrs), [l.renderSlot(t.$slots, "default", {}, void 0, !0)], 16)])) : l.createCommentVNode("v-if", !0);
		}
		const mn = D(dn, [["render", pn], ["__scopeId", "data-v-90fe8380"]]), hn = l.defineComponent({
			name: "HeatmapLayer",
			props: { options: {
				type: Object,
				default: () => ({})
			...
			setup(t) {
				const e = l.ref(), r = l.inject(M, l.ref()), n = l.inject(A, l.ref());
				return l.watch([r, () => t.options], ([o, s], [i, c]) => {
					const a = !V(s, c) || r.value !== i;
					if (r.value && n.value && a) {
						let d;
						if (s.data && !(s.data instanceof n.value.MVCArray)) {
							const p = n.value.LatLng, u = s.data.map((m) => m instanceof p || "location" in m && (m.location instanceof p || m.location === null) ? m : "location" in m ? {
								...m,
								location: new p(m.location)
							} : new p(m));
							d = {
								...s,
								data: u
						...
						e.value ? e.value.setOptions(d) : e.value = l.markRaw(new n.value.visualization.HeatmapLayer({
							...d,
							map: r.value
						}));
					}
		...
		w.AdvancedMarker = Et, w.Circle = Mt, w.CustomControl = Pt, w.CustomMarker = mn, w.GoogleMap = mt, w.HeatmapLayer = hn, w.InfoWindow = jt, w.Marker = wt, w.MarkerCluster = un, w.Polygon = Ct, w.Polyline = _t, w.Rectangle = bt, w.apiSymbol = A, w.mapSymbol = M, w.mapTilesLoadedSymbol = se, Object.defineProperty(w, Symbol.toStringTag, { value: "Module" });
	});
}));
//#endregion
