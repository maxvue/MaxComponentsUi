import { G as createBaseVNode, Ht as openBlock, K as createBlock, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Yt as renderSlot, q as createCommentVNode, t as Transition, w as vShow, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$1 } from "./basecomponent-BLHYi_5s.js";
//#region ../node_modules/primevue/accordioncontent/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/accordioncontent/index.mjs
var script = {
	name: "AccordionContent",
	"extends": {
	...
	return !_ctx.asChild ? (openBlock(), createBlock(Transition, mergeProps({
		...
		"default": withCtx(function() {
			return [($options.$pcAccordion.lazy ? $options.$pcAccordionPanel.active : true) ? withDirectives((openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
				...
				"default": withCtx(function() {
					return [createBaseVNode("div", mergeProps({ "class": _ctx.cx("contentWrapper") }, _ctx.ptm("contentWrapper", $options.ptParams)), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("content") }, _ctx.ptm("content", $options.ptParams)), [renderSlot(_ctx.$slots, "default")], 16)], 16)];
				}),
				_: 3
...
//# sourceMappingURL=accordioncontent-B71x-pE8.js.map