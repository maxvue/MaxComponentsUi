import { Ht as openBlock, J as createElementBlock, Jt as renderList, N as Fragment, Ot as mergeProps, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, tt as createVNode } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { Vt as Yt } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$1 } from "./baseinput-r8EDSDeX.js";
import { t as script$2 } from "./inputtext-oiJ80p0a.js";
//#endregion
...
//#endregion
//#region ../node_modules/primevue/inputotp/index.mjs
var script = {
	name: "InputOtp",
	"extends": {
		name: "BaseInputOtp",
	...
	methods: {
		getTemplateAttrs: function getTemplateAttrs(index) {
			return { value: this.tokens[index] };
		},
		...
		onInput: function onInput(event, index) {
			...
			if (event.inputType === "deleteContentBackward") this.moveToPrev(event);
			else if (event.inputType === "insertText" || event.inputType === "deleteContentForward" || Yt() && event instanceof CustomEvent) this.moveToNext(event);
		},
		...
		onKeyDown: function onKeyDown(event) {
			...
			switch (event.key) {
				...
				default:
					...
					if (!(this.integerOnly ? /^[0-9]$/.test(event.key) : true) || isAtMaxLength && event.key !== "Delete" && !hasSelection) event.preventDefault();
					break;
			}
		},
	...
	components: { OtpInputText: script$2 }
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
	var _component_OtpInputText = resolveComponent("OtpInputText");
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.length, function(i) {
