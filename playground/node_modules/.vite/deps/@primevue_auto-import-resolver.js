//#region node_modules/@primevue/metadata/index.mjs
var form = toMeta([
	"AutoComplete",
	"Calendar",
	"CascadeSelect",
...
//#endregion
//#region node_modules/@primevue/auto-import-resolver/index.mjs
function PrimeVueResolver(options = {}) {
	...
	return [{
		...
		resolve: (name) => {
			...
			if (cMeta) return ((_a = options == null ? void 0 : options.resolve) == null ? void 0 : _a.call(options, cMeta, "component")) ?? { from: cMeta.from };
		}
	}, {
		type: "directive",
		resolve: (name) => {
			...
			if (dMeta) return ((_a = options == null ? void 0 : options.resolve) == null ? void 0 : _a.call(options, dMeta, "directive")) ?? {
				as: dMeta.as,
				from: dMeta.from
			};
		}
...
//#endregion
export { PrimeVueResolver };

//# sourceMappingURL=@primevue_auto-import-resolver.js.map