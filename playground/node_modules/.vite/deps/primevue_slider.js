import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Ot as mergeProps, q as createCommentVNode } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { At as Q, Lt as V, Qt as k, R as f, dt as $ } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$2 } from "./baseeditableholder-D0Nbos50.js";
//#endregion
//#region ../node_modules/primevue/slider/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/slider/index.mjs
var script$1 = {
	name: "BaseSlider",
	"extends": script$2,
	props: {
...
var script = {
	...
	methods: {
		...
		setValue: function setValue(event) {
			...
			if (this.orientation === "horizontal") if (V(this.$el)) handleValue = (this.initX + this.barWidth - pageX) * 100 / this.barWidth;
		...
		onDrag: function onDrag(event) {
			if (this.dragging) this.setValue(event);
		},
		...
		decrementValue: function decrementValue(event, index) {
			...
			var newValue;
			if (this.range) if (this.step) newValue = this.value[index] - this.step;
			else newValue = this.value[index] - 1;
			else if (this.step) newValue = this.value - this.step;
		...
		rangeStyle: function rangeStyle() {
			...
			} else if (this.horizontal) return { width: this.handlePosition + "%" };
			else return { height: this.handlePosition + "%" };
		},
		handleStyle: function handleStyle() {
			if (this.horizontal) return { "inset-inline-start": this.handlePosition + "%" };
			else return { bottom: this.handlePosition + "%" };
		},
		rangeStartHandleStyle: function rangeStartHandleStyle() {
			if (this.horizontal) return { "inset-inline-start": this.rangeStartPosition + "%" };
			else return { bottom: this.rangeStartPosition + "%" };
		},
		rangeEndHandleStyle: function rangeEndHandleStyle() {
			if (this.horizontal) return { "inset-inline-start": this.rangeEndPosition + "%" };
	...
	computed: {
		...
		rangeStartPosition: function rangeStartPosition() {
			if (this.value && this.value[0] !== void 0) if (this.value[0] < this.min) return 0;
			else return (this.value[0] - this.min) * 100 / (this.max - this.min);
			else return 0;
		},
		rangeEndPosition: function rangeEndPosition() {
			if (this.value && this.value.length === 2 && this.value[1] !== void 0) if (this.value[1] > this.max) return 100;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", mergeProps({
		...
		}, _ctx.ptm("handle"), { "data-p": $options.dataP }), null, 16, _hoisted_3)) : createCommentVNode("", true),
		_ctx.range ? (openBlock(), createElementBlock("span", mergeProps({
			key: 1,
			"class": _ctx.cx("handle"),
			...
			"aria-label": _ctx.ariaLabel,
			"aria-orientation": _ctx.orientation
		}, _ctx.ptm("startHandler"), { "data-p": $options.dataP }), null, 16, _hoisted_4)) : createCommentVNode("", true),
		_ctx.range ? (openBlock(), createElementBlock("span", mergeProps({
			key: 2,
			"class": _ctx.cx("handle"),
			...
			"aria-label": _ctx.ariaLabel,
			"aria-orientation": _ctx.orientation
		}, _ctx.ptm("endHandler"), { "data-p": $options.dataP }), null, 16, _hoisted_5)) : createCommentVNode("", true)
	], 16, _hoisted_1);
}
