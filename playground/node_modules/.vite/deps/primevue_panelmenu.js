import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, jr as toDisplayString, q as createCommentVNode, t as Transition, tt as createVNode, w as vShow, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { At as Q, G as J, J as V, Kt as bt, at as l, it as k, on as z, ot as m, ut as s } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$4 } from "./basecomponent-BLHYi_5s.js";
import { t as Ripple } from "./ripple-DZ2RYtk8.js";
import { t as script$5 } from "./chevronright-aBzqRXmf.js";
import { t as script$6 } from "./chevrondown-CJdOe-id.js";
//#endregion
//#region ../node_modules/primevue/panelmenu/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/panelmenu/index.mjs
var script$3 = {
	name: "BasePanelMenu",
	"extends": script$4,
	props: {
	...
	methods: {
		...
		getMenuItemProps: function getMenuItemProps(processedItem, index) {
			return {
				...
				icon: mergeProps({ "class": [this.cx("itemIcon"), this.getItemProp(processedItem, "icon")] }, this.getPTOptions("itemIcon", processedItem, index)),
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("ul", {
		...
		return openBlock(), createElementBlock(Fragment, { key: $options.getItemKey(processedItem) }, [$options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
			...
			$options.isItemGroup(processedItem) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [$props.templates.submenuicon ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.submenuicon), mergeProps({
				key: 0,
				"class": _ctx.cx("submenuIcon"),
				active: $options.isItemActive(processedItem)
			}, { ref_for: true }, $options.getPTOptions("submenuIcon", processedItem, index)), null, 16, ["class", "active"])) : (openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(processedItem) ? "ChevronDownIcon" : "ChevronRightIcon"), mergeProps({
				key: 1,
				"class": _ctx.cx("submenuIcon")
			...
			createBaseVNode("span", mergeProps({ "class": _ctx.cx("itemLabel") }, { ref_for: true }, $options.getPTOptions("itemLabel", processedItem, index)), toDisplayString($options.getItemLabel(processedItem)), 17)
		], 16, _hoisted_4$1)), [[_directive_ripple]]) : (openBlock(), createBlock(resolveDynamicComponent($props.templates.item), {
			key: 1,
			item: processedItem.item,
			root: false,
			active: $options.isItemActive(processedItem),
			...
			"label",
			"props"
		]))], 16, _hoisted_3$1), createVNode(Transition, mergeProps({ name: "p-collapsible" }, { ref_for: true }, _ctx.ptm("transition")), {
			"default": withCtx(function() {
				return [withDirectives(createBaseVNode("div", mergeProps({ "class": _ctx.cx("contentContainer") }, { ref_for: true }, _ctx.ptm("contentContainer")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("contentWrapper") }, { ref_for: true }, _ctx.ptm("contentWrapper")), [$options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_PanelMenuSub, mergeProps({
					key: 0,
					...
					"pt",
					"unstyled"
				])) : createCommentVNode("", true)], 16)], 16), [[vShow, $options.isItemActive(processedItem)]])];
			}),
			_: 2
...
var script$1 = {
	...
	watch: { expandedKeys: function expandedKeys(newValue) {
	...
	methods: {
		...
		onArrowLeftKey: function onArrowLeftKey(event) {
			...
			if (s(this.focusedItem)) {
				if (this.activeItemPath.some(function(p) {
					return p.key === _this.focusedItem.key;
				})) this.activeItemPath = this.activeItemPath.filter(function(p) {
					return p.key !== _this.focusedItem.key;
				});
				else this.focusedItem = s(this.focusedItem.parent) ? this.focusedItem.parent : this.focusedItem;
				event.preventDefault();
			}
		},
		onArrowRightKey: function onArrowRightKey(event) {
			var _this2 = this;
			if (s(this.focusedItem)) {
				if (this.isItemGroup(this.focusedItem)) if (this.activeItemPath.some(function(p) {
		...
		onItemToggle: function onItemToggle(event) {
			...
			if (this.expandedKeys) this.$emit("item-toggle", {
				item: processedItem.item,
				expanded
			});
			else {
		...
		onItemMouseMove: function onItemMouseMove(event) {
			if (this.focused) this.focusedItem = event.processedItem;
		},
		...
		findNextItem: function findNextItem(processedItem) {
			...
			return (index < this.visibleItems.length - 1 ? this.visibleItems.slice(index + 1).find(function(pItem) {
				return _this5.isValidItem(pItem);
			}) : void 0) || processedItem;
		},
		findPrevItem: function findPrevItem(processedItem) {
			...
			return (index > 0 ? V(this.visibleItems.slice(0, index), function(pItem) {
		...
		searchItems: function searchItems(event, _char) {
			...
			} else matchedItem = this.visibleItems.find(function(processedItem) {
				return _this7.isItemMatched(processedItem);
			});
			if (s(matchedItem)) matched = true;
			if (l(matchedItem) && l(this.focusedItem)) matchedItem = this.findFirstItem();
			if (s(matchedItem)) this.changeFocusedItem({
				originalEvent: event,
		...
		changeFocusedItem: function changeFocusedItem(event) {
			...
			if (s(this.focusedItem) && this.focusedItem.key !== processedItem.key) {
				this.focusedItem = processedItem;
				this.scrollInView();
			} else if (allowHeaderFocus) this.$emit("header-focus", {
				originalEvent,
				focusOnNext,
				selfCheck
			});
	...
	components: { PanelMenuSub: script$2 }
};
	...
	methods: {
		...
		isItemActive: function isItemActive(item) {
			return this.expandedKeys ? this.expandedKeys[this.getItemProp(item, "key")] : this.multiple ? this.activeItems.some(function(subItem) {
				return k(item, subItem);
			}) : k(item, this.activeItem);
		},
		...
		findNextHeader: function findNextHeader(panelElement) {
			var headerElement = z((arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false) ? panelElement : panelElement.nextElementSibling, "[data-pc-section=\"header\"]");
		...
		findPrevHeader: function findPrevHeader(panelElement) {
			var headerElement = z((arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false) ? panelElement : panelElement.previousElementSibling, "[data-pc-section=\"header\"]");
		...
		updateFocusedHeader: function updateFocusedHeader(event) {
			...
			var header = selfCheck ? z(panelElement, "[data-pc-section=\"header\"]") : focusOnNext ? this.findNextHeader(panelElement) : this.findPrevHeader(panelElement);
		...
		changeActiveItem: function changeActiveItem(event, item) {
			...
			if (!this.isItemDisabled(item)) {
				...
				this.activeItem = selfActive ? item : this.activeItem && k(item, this.activeItem) ? null : item;
				if (this.multiple) if (this.activeItems.some(function(subItem) {
					return k(item, subItem);
		...
		getMenuItemProps: function getMenuItemProps(item, index) {
			return {
				icon: mergeProps({ "class": [this.cx("headerIcon"), this.getItemProp(item, "icon")] }, this.getPTOptions("headerIcon", item, index)),
				label: mergeProps({ "class": this.cx("headerLabel") }, this.getPTOptions("headerLabel", item, index))
			};
		}
	},
	components: {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		return openBlock(), createElementBlock(Fragment, { key: $options.getPanelKey(index) }, [$options.isItemVisible(item) ? (openBlock(), createElementBlock("div", mergeProps({
			key: 0,
			style: $options.getItemProp(item, "style"),
			"class": [_ctx.cx("panel"), $options.getItemProp(item, "class")]
		}, { ref_for: true }, _ctx.ptm("panel")), [createBaseVNode("div", mergeProps({
			id: $options.getHeaderId(index),
			"class": [_ctx.cx("header", { item }), $options.getItemProp(item, "headerClass")],
		...
		}, { ref_for: true }, $options.getPTOptions("header", item, index), {
			"data-p-active": $options.isItemActive(item),
			"data-p-disabled": $options.isItemDisabled(item)
		}), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("headerContent") }, { ref_for: true }, $options.getPTOptions("headerContent", item, index)), [!_ctx.$slots.item ? (openBlock(), createElementBlock("a", mergeProps({
			key: 0,
			href: $options.getItemProp(item, "url"),
			"class": _ctx.cx("headerLink"),
			tabindex: -1
		}, { ref_for: true }, $options.getPTOptions("headerLink", item, index)), [
			$options.getItemProp(item, "items") ? renderSlot(_ctx.$slots, "submenuicon", {
				key: 0,
				active: $options.isItemActive(item)
			}, function() {
				return [(openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(item) ? "ChevronDownIcon" : "ChevronRightIcon"), mergeProps({ "class": _ctx.cx("submenuIcon") }, { ref_for: true }, $options.getPTOptions("submenuIcon", item, index)), null, 16, ["class"]))];
			...
			}, { ref_for: true }, $options.getPTOptions("headerIcon", item, index)), null, 16)) : createCommentVNode("", true),
			createBaseVNode("span", mergeProps({ "class": _ctx.cx("headerLabel") }, { ref_for: true }, $options.getPTOptions("headerLabel", item, index)), toDisplayString($options.getItemLabel(item)), 17)
		], 16, _hoisted_3)) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.item), {
			key: 1,
			item,
			root: true,
			active: $options.isItemActive(item),
			...
			"label",
			"props"
		]))], 16)], 16, _hoisted_2), createVNode(Transition, mergeProps({ name: "p-collapsible" }, { ref_for: true }, _ctx.ptm("transition")), {
			"default": withCtx(function() {
				return [withDirectives(createBaseVNode("div", mergeProps({
				...
				}, { ref_for: true }, _ctx.ptm("contentContainer")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("contentWrapper") }, { ref_for: true }, _ctx.ptm("contentWrapper")), [$options.getItemProp(item, "items") ? (openBlock(), createElementBlock("div", mergeProps({
					key: 0,
					"class": _ctx.cx("content")
				}, { ref_for: true }, _ctx.ptm("content")), [createVNode(_component_PanelMenuList, {
					...
					"pt",
					"unstyled"
				])], 16)) : createCommentVNode("", true)], 16)], 16, _hoisted_4), [[vShow, $options.isItemActive(item)]])];
			}),
			_: 2
