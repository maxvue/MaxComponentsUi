import { Er as normalizeProps, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Q as createSlots, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, Zt as resolveDirective, et as createTextVNode, jr as toDisplayString, q as createCommentVNode, tt as createVNode, wn as withDirectives } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { G as J, K as M, Kt as bt, R as f, an as vt, ct as p, it as k, on as z, qt as c, ut as s } from "./dist-Dc7XnIxt.js";
import { t as BaseStyle } from "./style-Dey3MFKD.js";
import "./vue.js";
import { t as script$2 } from "./baseeditableholder-D0Nbos50.js";
import { t as script$3 } from "./inputtext-oiJ80p0a.js";
import { t as Ripple } from "./ripple-DZ2RYtk8.js";
import { t as script$4 } from "./iconfield-C-mr3ivq.js";
import { t as script$5 } from "./inputicon-BZjKHfPi.js";
import { t as script$6 } from "./virtualscroller-B8t8phff.js";
import { t as script$7 } from "./check-DeOt25Y5.js";
import { r as FilterService } from "./api-DQ9IOApK.js";
import { t as script$8 } from "./blank-C-paN6mx.js";
import { t as script$9 } from "./search-bdYteUlY.js";
//#endregion
...
//#endregion
//#region ../node_modules/primevue/listbox/index.mjs
var script$1 = {
	name: "BaseListbox",
	"extends": script$2,
	props: {
...
var script = {
	...
	methods: {
		...
		getOptionLabel: function getOptionLabel(option) {
			return this.optionLabel ? p(option, this.optionLabel) : typeof option === "string" || typeof option === "number" || typeof option === "boolean" ? option : null;
		},
		...
		onLastHiddenFocus: function onLastHiddenFocus(event) {
			if (event.relatedTarget === this.list) {
				bt(vt(this.$el, ":not([data-p-hidden-focusable=\"true\"])"));
				this.$refs.firstHiddenFocusableElement.tabIndex = void 0;
			} else bt(this.$refs.firstHiddenFocusableElement);
			this.$refs.lastHiddenFocusableElement.tabIndex = -1;
		},
		onFocusout: function onFocusout(event) {
			if (!this.$el.contains(event.relatedTarget) && this.$refs.lastHiddenFocusableElement && this.$refs.firstHiddenFocusableElement) this.$refs.lastHiddenFocusableElement.tabIndex = this.$refs.firstHiddenFocusableElement.tabIndex = void 0;
		},
		...
		onOptionMouseMove: function onOptionMouseMove(event, index) {
			if (this.focusOnHover && this.focused) this.changeFocusedOptionIndex(event, index);
		},
		...
		onOptionSelectSingle: function onOptionSelectSingle(event, option) {
			...
			var value = null;
			if (this.optionTouched ? false : this.metaKeySelection) {
		...
		onOptionSelectMultiple: function onOptionSelectMultiple(event, option) {
			...
			if (this.optionTouched ? false : this.metaKeySelection) {
				var metaKey = event.metaKey || event.ctrlKey;
				if (selected) value = metaKey ? this.removeOption(option) : [this.getOptionValue(option)];
				else {
					value = metaKey ? this.d_value || [] : [];
					value = [].concat(_toConsumableArray(value), [this.getOptionValue(option)]);
				}
			} else value = selected ? this.removeOption(option) : [].concat(_toConsumableArray(this.d_value || []), [this.getOptionValue(option)]);
			this.updateModel(event, value);
		},
		...
		onEnterKey: function onEnterKey(event) {
			if (this.focusedOptionIndex !== -1) if (this.multiple && event.shiftKey) this.onOptionSelectRange(event, this.focusedOptionIndex);
		...
		findSelectedOptionIndex: function findSelectedOptionIndex() {
			...
			} else return this.visibleOptions.findIndex(function(option) {
		...
		removeOption: function removeOption(option) {
			...
			return this.d_value.filter(function(val) {
				return !k(val, _this13.getOptionValue(option), _this13.equalityKey);
			});
		},
		changeFocusedOptionIndex: function changeFocusedOptionIndex(event, index) {
			if (this.focusedOptionIndex !== index) {
				...
				this.scrollInView();
				if (this.selectOnFocus && !this.multiple) this.onOptionSelect(event, this.visibleOptions[index]);
			}
		},
	...
	computed: {
		...
		optionsListGroup: function optionsListGroup() {
			...
			(this.options || []).forEach(function(optionGroup) {
				...
				if (filteredChildren !== null && filteredChildren !== void 0 && filteredChildren.length) filteredOptions.push.apply(filteredOptions, [{
					optionGroup,
					group: true
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		createBaseVNode("div", mergeProps({
			...
			style: [{ "max-height": $options.virtualScrollerDisabled ? _ctx.scrollHeight : "" }, _ctx.listStyle]
			...
			style: [{ height: _ctx.scrollHeight }, _ctx.listStyle],
			tabindex: -1,
			...
			content: withCtx(function(_ref) {
				...
				return [createBaseVNode("ul", mergeProps({
					...
					}, { ref_for: true }, $options.getPTOptions(option, getItemOptions, i, "option"), {
						"data-p-selected": !_ctx.checkmark && $options.isSelected(option),
						"data-p-focused": $data.focusedOptionIndex === $options.getOptionIndex(i, getItemOptions),
						"data-p-disabled": $options.isOptionDisabled(option)
					}), [_ctx.checkmark ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [$options.isSelected(option) ? (openBlock(), createBlock(_component_CheckIcon, mergeProps({
						key: 0,
...
//# sourceMappingURL=listbox-Knh7BPaU.js.map