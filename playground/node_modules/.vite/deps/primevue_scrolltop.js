import { Ht as openBlock, K as createBlock, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Tr as normalizeClass, Xt as resolveComponent, Yt as renderSlot, q as createCommentVNode, t as Transition } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { dt as $, z as x } from "./dist-Dc7XnIxt.js";
...
//#endregion
//#region ../node_modules/primevue/scrolltop/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/scrolltop/index.mjs
var script = {
	name: "ScrollTop",
	"extends": {
		name: "BaseScrollTop",
			...
			return [$data.visible ? (openBlock(), createBlock(_component_Button, mergeProps({
				...
				icon: withCtx(function(slotProps) {
					return [renderSlot(_ctx.$slots, "icon", { "class": normalizeClass(_ctx.cx("icon")) }, function() {
						return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.icon ? "span" : "ChevronUpIcon"), mergeProps({ "class": [
							_ctx.cx("icon"),
							_ctx.icon,
							slotProps["class"]
						] }, _ctx.ptm("root")["icon"], { "data-pc-section": "icon" }), null, 16, ["class"]))];
					})];
				}),
				_: 3
			}, 16, [
