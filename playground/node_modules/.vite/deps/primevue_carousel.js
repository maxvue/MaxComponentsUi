import { G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, N as Fragment, Ot as mergeProps, Qt as resolveDynamicComponent, Sn as withCtx, Xt as resolveComponent, Yt as renderSlot, et as createTextVNode, jr as toDisplayString, q as createCommentVNode } from "./runtime-dom.esm-bundler-C69FAPN8.js";
import { At as Q, Bt as Y, Rt as W, Ut as _t, Y as W$1, et as ee, kt as P, on as z } from "./dist-Dc7XnIxt.js";
...
import { t as script$4 } from "./chevronright-aBzqRXmf.js";
import { t as script$5 } from "./chevronup-DA__r3fZ.js";
import { t as script$6 } from "./chevrondown-CJdOe-id.js";
import { t as script$7 } from "./chevronleft-DQZEKSLw.js";
//#endregion
//#region ../node_modules/primevue/carousel/style/index.mjs
...
//#endregion
//#region ../node_modules/primevue/carousel/index.mjs
var script$1 = {
	name: "BaseCarousel",
	"extends": script$2,
	props: {
...
var script = {
	...
	methods: {
		...
		onTouchMove: function onTouchMove(e) {
			...
			if (Math.abs(diff) > this.swipeThreshold && e.cancelable) e.preventDefault();
		},
		...
		changePageOnTouch: function changePageOnTouch(e, diff) {
			if (Math.abs(diff) > this.swipeThreshold) if (diff < 0) this.navForward(e);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		!$options.empty ? (openBlock(), createElementBlock("div", mergeProps({
			...
			_ctx.showNavigators ? (openBlock(), createBlock(_component_Button, mergeProps({
				...
				icon: withCtx(function(slotProps) {
					return [renderSlot(_ctx.$slots, "previcon", {}, function() {
						return [(openBlock(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronUpIcon" : "ChevronLeftIcon"), mergeProps({ "class": slotProps.icon }, _ctx.ptm("pcPrevButton")["icon"]), null, 16, ["class"]))];
					})];
				}),
				_: 3
			}, 16, [
			...
			_ctx.showNavigators ? (openBlock(), createBlock(_component_Button, mergeProps({
				...
				icon: withCtx(function(slotProps) {
					return [renderSlot(_ctx.$slots, "nexticon", {}, function() {
						return [(openBlock(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronDownIcon" : "ChevronRightIcon"), mergeProps({ "class": slotProps["class"] }, _ctx.ptm("pcNextButton")["icon"]), null, 16, ["class"]))];
					})];
				}),
				_: 3
			}, 16, [
			...
			}, { ref_for: true }, $options.getIndicatorPTOptions("indicator", i), { "data-p-active": $data.d_page === i }), [createBaseVNode("button", mergeProps({
		...
		}), 128))], 16)) : createCommentVNode("", true)], 16)) : renderSlot(_ctx.$slots, "empty", { key: 2 }, function() {
