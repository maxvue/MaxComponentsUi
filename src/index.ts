...
export type { MaxTimelineProps, MaxTimelineAlign, MaxTimelineLayout } from './components/MaxTimeline.vue';
...
export { MODAL_CONTEXT_KEY, provideModalContext, useModalContext, resolveModalZIndex, type ModalContext } from './helpers/modalContext';
export { useOverlayZIndex, type OverlayLayer, type UseOverlayZIndexOptions } from './composables/useOverlayZIndex';
export { useActiveOverlayPosition, type UseActiveOverlayPositionOptions, type OverlayPositionResult } from './composables/useActiveOverlayPosition';
