<template>
    <nav class="max-bottom-menu bottom-menu" :class="{ 'is-curved': props.curved && hasFab }">
        ...
        <svg
            ...
            aria-hidden="true"
        >
            <path d="M300 82 C270.0 82 265.0 35.0 240.0 20.0 C230.0 10.0 220.0 10.0 210.0 10.0 L0 10 L0 120 L600 120 L600 10 L390.0 10.0 C380.0 10.0 370.0 10.0 360.0 20.0 C335.0 35.0 330.0 82 300 82 Z" />
        </svg>
