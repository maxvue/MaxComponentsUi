...
| IMP5-R18 | implementação | R18 | concluído | reduced motion; Chromium reduce/no-preference |
...
| REV5-R16 | refutação | R16 | REJEITADO — parser é regex de template e retorna a política global sem associar alvo/estado; browser injeta foco em famílias sintéticas e o inventário marca o rótulo informativo de MaxEmptyDiv como decorativo (3,30:1 no claro) | agente `/root/rev5_r16`; início `2026-09-15T15:06:00-03:00`; fim `2026-09-15T15:08:35-03:00`; HEAD auditado `107cef7a`; referência `aac16bca`; relatório `docs/optimize-new/execution-fix5/REV5-R16.md`; somente leitura |
| REV5-R17 | refutação | R17 | REJEITADO — o gate passa e detecta a mutação do token consumido, mas não verifica `focus-visible`/`active`/`disabled` de `solid`, trata `active` transparente como repouso e não audita o seletor específico `dashed/whatsapp`; E10-02 permanece aberto | agente `/root/rev5_r17`; início `2026-09-15T15:07:00-03:00`; fim `2026-09-15T15:10:00-03:00`; HEAD auditado `107cef7a`; referência `aac16bca`; relatório `docs/optimize-new/execution-fix5/REV5-R17.md`; somente leitura |
