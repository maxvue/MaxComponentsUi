...
| 2  | MaxInputText | baixa | [MaxInputText.md](migration_plans/MaxInputText.md) | InputBase | waiting |
| 3  | MaxInputTextList | baixa | [MaxInputTextList.md](migration_plans/MaxInputTextList.md) | InputBase | waiting |
| 4  | MaxInputTextArea | baixa | [MaxInputTextArea.md](migration_plans/MaxInputTextArea.md) | InputBase | waiting |
| 5  | MaxInputSearch | baixa | [MaxInputSearch.md](migration_plans/MaxInputSearch.md) | InputBase | waiting |
...
| 25 | MaxPhoneField | alta | [MaxPhoneField.md](migration_plans/MaxPhoneField.md) | InputBase, MaxInputSelect | waiting |
