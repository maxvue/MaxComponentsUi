...
export declare function createCurrencyMask(decimals?: number): any;
export declare function createNumberMaskBr(decimals?: number): (rawValue?: string) => any[];
...
export declare const maskBr: {
    ...
    createCurrencyTextMask: (decimals?: number) => any;
    createNumberTextMask: (decimals?: number) => (rawValue?: string) => any[];
};
/**
 * FROM TEXT-MASK
 */
